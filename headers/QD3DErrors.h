...
#pragma options(!pack_enums)
  ...
  enum TQ3Error
  {
    kQ3ErrorNone = 0,                                            /** Errors */
    kQ3ErrorInternalError = -28500 kQ3ErrorNoRecovery            // Fatal Errors
                                kQ3ErrorLastFatalError = -28498, /** Errors */
    kQ3ErrorNotInitialized = -28490 kQ3ErrorAlreadyInitialized = -28489,
    kQ3ErrorUnimplemented = -28488,      // System Errors
    kQ3ErrorRegistrationFailed = -28487, /** Errors */
    kQ3ErrorUnixError = -28486 kQ3ErrorMacintoshError = -28485,
    kQ3ErrorX11Error = -28484,                                /** Errors */
    kQ3ErrorMemoryLeak = -28483 kQ3ErrorOutOfMemory = -28482, // Para// OS Errors
    ...
    kQ3ErrorVector3DNotUnitLength            // Parameter errors
        kQ3ErrorVector3DZeroLength = -28475, /** Errors */
    kQ3ErrorInvalidObject = -28474 kQ3ErrorInvalidObjectClass = -28473,
    ...
    kQ3ErrorNotSupported = -28464, /** Errors */
    kQ3ErrorNoExtensionsFolder = -28463 kQ3ErrorExtensionError = -28462,
    kQ3ErrorPrivateExtensionError = -28461,                                                  /** Errors */
    kQ3ErrorDegenerateGeometry = -28460 kQ3ErrorGeometryInsufficientNumberOfPoints = -28459, /** Errors */
    kQ3ErrorNoStorageSetForFile = -28458 kQ3ErrorEndOfFile = -28457,
    ...
    kQ3ErrorFileVersionExists = -28420, /** errors */
    kQ3ErrorViewNotStarted = -28419 kQ3ErrorViewIsStarted = -28418,
    ...
    kQ3ErrorNothingToPop = -28406, /** Errors */
    kQ3ErrorUnknownStudioType = -28405 kQ3ErrorAlreadyRendering = -28404,
    kQ3ErrorStartGroupRange = -28403,
    kQ3ErrorUnsupportedGeometryType = -28402,
    kQ3ErrorInvalidGeometryType = -28401,
    kQ3ErrorUnsupportedFunctionality = -28400, /** Errors */
    kQ3ErrorInvalidPositionForGroup = -28399 kQ3ErrorInvalidObjectForGroup = -28398,
    kQ3ErrorInvalidObjectForPosition = -28397,                                                                                  /** Errors */
    kQ3ErrorScaleOfZero = -28396                                                                                                /** Errors */
                          kQ3ErrorBadStringType = -28395                                                                        /** Errors */
                                                  kQ3ErrorAttributeNotContained = -28394 kQ3ErrorAttributeInvalidType = -28393, /** Errors */
    kQ3ErrorInvalidCameraValues = -28392                                                                                        /** Errors */
                                  kQ3ErrorBadDrawContextType = -28391 kQ3ErrorBadDrawContextFlag = -28390,
    ...
    kQ3ErrorTypeAlreadyExistsAndHasObjectInstances =
        -28382,                                           /* submit loop errors: if you ever get one of these check the
                                                             previous*/
                                                          /** posted, */
    it may be kQ3ErrorOutOfMemory.If so you *may *be able // to recover by freeing up some memory and trying again  kQ3ErrorPickingLoopFailed  =  -28381
  ...
  enum TQ3Warning
  {
    ...
    kQ3WarningStringExceedsMaximumLength = -28277,                                                                                                                                                                                    /** Warnings */
    kQ3WarningLowMemory = -28276 kQ3WarningPossibleMemoryLeak = -28275,                                                                                                                                                               /** Warnings */
    kQ3WarningViewTraversalInProgress = -28274 kQ3WarningNonInvertibleMatrix = -28273,                                                                                                                                                /** Warning */
    kQ3WarningQuaternionEntriesAreZero = -28272                                                                                                                                                                                       /** Warning */
                                         kQ3WarningFunctionalityNotSupported = -28271                                                                                                                                                 /** Warning */
                                                                               kQ3WarningInvalidPaneDimensions = -28270                                                                                                               /** Warning */
                                                                                                                 kQ3WarningPickParamOutside = -28269                                                                                  /** Warnings */
                                                                                                                                              kQ3WarningScaleEntriesAllZero = -28268 kQ3WarningScaleContainsNegativeEntries = -28267, /** Warnings */
    kQ3WarningParameterOutOfRange = -28266                                                                                                                                                                                            /** Warnings */
                                    kQ3WarningExtensionNotLoading = -28265                                                                                                                                                            /** Warnings */
                                                                    kQ3WarningTypeAlreadyRegistered = -28264 kQ3WarningTypeSameVersionAlreadyRegist                                                                                   // General System
