...
#define DisposeIconGetterUPP(userUPP) DisposeRoutineDescriptor(userUPP)
   ...
   */
  EXTERN_API_C(OSErr)
  InvokeIconActionUPP(ResType theType, Handle *theIcon, void *yourDataPtr, IconActionUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline OSErr InvokeIconActionUPP(ResType theType, Handle *theIcon, void *yourDataPtr, IconActionUPP userUPP)
  {
...
#define InvokeIconActionUPP(theType, theIcon, yourDataPtr, userUPP) \
  (OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppIconActionProcInfo, \ (theType), (theIcon), (yourDataPtr))
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline Handle InvokeIconGetterUPP(ResType theType, void *yourDataPtr, IconGetterUPP userUPP)
  {
...
#define InvokeIconGetterUPP(theType, yourDataPtr, userUPP) \
  (Handle) CALL_TWO_PARAMETER_UPP((userUPP), uppIconGetterProcInfo, (theType), \ (yourDataPtr))
#endif
#endif
...
#define CallIconGetterProc(userRoutine, theType, yourDataPtr) \
   ...
   */
  EXTERN_API(void)
  PlotCIcon(const Rect *theRect, CIconHandle theIcon) ONEWORDINLINE(0xAA1F);
   ...
   */
  EXTERN_API(void)
  PlotIcon(const Rect *theRect, Handle theIcon) ONEWORDINLINE(0xA94B);

  /**  \note IconSuiteRef and IconCacheRef should be an abstract types, but too much source code already relies on them being of type Handle. */
   ...
   */
  EXTERN_API(OSErr)
  PlotIconID(const Rect *theRect, IconAlignmentType align, IconTransformType transform, SInt16 theResID) THREEWORDINLINE(0x303C, 0x0500, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  AddIconToSuite(Handle theIconData, IconSuiteRef theSuite, ResType theType) THREEWORDINLINE(0x303C, 0x0608, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  GetIconFromSuite(Handle *theIconData, IconSuiteRef theSuite, ResType theType) THREEWORDINLINE(0x303C, 0x0609, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  ForEachIconDo(IconSuiteRef theSuite, IconSelectorValue selector, IconActionUPP action, void *yourDataPtr) THREEWORDINLINE(0x303C, 0x080A, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  GetIconSuite(IconSuiteRef *theIconSuite, SInt16 theResID, IconSelectorValue selector) THREEWORDINLINE(0x303C, 0x0501, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  DisposeIconSuite(IconSuiteRef theIconSuite, Boolean disposeData) THREEWORDINLINE(0x303C, 0x0302, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  PlotIconSuite(const Rect *theRect, IconAlignmentType align, IconTransformType transform, IconSuiteRef theIconSuite) THREEWORDINLINE(0x303C, 0x0603, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  MakeIconCache(IconCacheRef *theCache, IconGetterUPP makeIcon, void *yourDataPtr) THREEWORDINLINE(0x303C, 0x0604, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  LoadIconCache(const Rect *theRect, IconAlignmentType align, IconTransformType transform, IconCacheRef theIconCache) THREEWORDINLINE(0x303C, 0x0606, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  PlotIconMethod(const Rect *theRect, IconAlignmentType align, IconTransformType transform, IconGetterUPP theMethod, void *yourDataPtr) THREEWORDINLINE(0x303C, 0x0805, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  GetLabel(SInt16 labelNumber, RGBColor *labelColor, Str255 labelString) THREEWORDINLINE(0x303C, 0x050B, 0xABC9);
   ...
   */
  EXTERN_API(Boolean)
  PtInIconID(Point testPt, const Rect *iconRect, IconAlignmentType align, SInt16 iconID) THREEWORDINLINE(0x303C, 0x060D, 0xABC9);
   ...
   */
  EXTERN_API(Boolean)
  PtInIconSuite(Point testPt, const Rect *iconRect, IconAlignmentType align, IconSuiteRef theIconSuite) THREEWORDINLINE(0x303C, 0x070E, 0xABC9);
   ...
   */
  EXTERN_API(Boolean)
  PtInIconMethod(Point testPt, const Rect *iconRect, IconAlignmentType align, IconGetterUPP theMethod, void *yourDataPtr) THREEWORDINLINE(0x303C, 0x090F, 0xABC9);
   ...
   */
  EXTERN_API(Boolean)
  RectInIconID(const Rect *testRect, const Rect *iconRect, IconAlignmentType align, SInt16 iconID) THREEWORDINLINE(0x303C, 0x0610, 0xABC9);
   ...
   */
  EXTERN_API(Boolean)
  RectInIconSuite(const Rect *testRect, const Rect *iconRect, IconAlignmentType align, IconSuiteRef theIconSuite) THREEWORDINLINE(0x303C, 0x0711, 0xABC9);
   ...
   */
  EXTERN_API(Boolean)
  RectInIconMethod(const Rect *testRect, const Rect *iconRect, IconAlignmentType align, IconGetterUPP theMethod, void *yourDataPtr) THREEWORDINLINE(0x303C, 0x0912, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  IconIDToRgn(RgnHandle theRgn, const Rect *iconRect, IconAlignmentType align, SInt16 iconID) THREEWORDINLINE(0x303C, 0x0613, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  IconSuiteToRgn(RgnHandle theRgn, const Rect *iconRect, IconAlignmentType align, IconSuiteRef theIconSuite) THREEWORDINLINE(0x303C, 0x0714, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  IconMethodToRgn(RgnHandle theRgn, const Rect *iconRect, IconAlignmentType align, IconGetterUPP theMethod, void *yourDataPtr) THREEWORDINLINE(0x303C, 0x0915, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  SetSuiteLabel(IconSuiteRef theSuite, SInt16 theLabel) THREEWORDINLINE(0x303C, 0x0316, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  GetIconCacheData(IconCacheRef theCache, void **theData) THREEWORDINLINE(0x303C, 0x0419, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  SetIconCacheData(IconCacheRef theCache, void *theData) THREEWORDINLINE(0x303C, 0x041A, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  GetIconCacheProc(IconCacheRef theCache, IconGetterUPP *theProc) THREEWORDINLINE(0x303C, 0x041B, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  SetIconCacheProc(IconCacheRef theCache, IconGetterUPP theProc) THREEWORDINLINE(0x303C, 0x041C, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  PlotIconHandle(const Rect *theRect, IconAlignmentType align, IconTransformType transform, Handle theIcon) THREEWORDINLINE(0x303C, 0x061D, 0xABC9);
   ...
   */
  EXTERN_API(OSErr)
  PlotSICNHandle(const Rect *theRect, IconAlignmentType align, IconTransformType transform, Handle theSICN) THREEWORDINLINE(0x303C, 0x061E, 0xABC9);
  ...
  */
  ...
  /**
   *  IconServicesInit()
   * Call this routine once per classic 68K application initialization. This routine does not need to be called at boot time.
   ...
   *  Call this routine once from the termination of a classic 68K application. This routine does not need to be called at boot time.
  ...
  /**
   * \name Converting data structures
   */

  /**
   *  IconRefToIconFamily()
   *  This routines returns a new IconFamily that contains the data corresponding to the specified IconRef.
   ...
   */
  EXTERN_API(OSErr)
  IconRefToIconFamily(IconRef theIconRef, IconSelectorValue whichIcons, IconFamilyHandle *iconFamily) TWOWORDINLINE(0x7024, 0xAA75);
   ...
   */
  EXTERN_API(OSErr)
  IconFamilyToIconSuite(IconFamilyHandle iconFamily, IconSelectorValue whichIcons, IconSuiteRef *iconSuite) TWOWORDINLINE(0x7025, 0xAA75);
   ...
   */
  EXTERN_API(OSErr)
  IconSuiteToIconFamily(IconSuiteRef iconSuite, IconSelectorValue whichIcons, IconFamilyHandle *iconFamily) TWOWORDINLINE(0x7026, 0xAA75);

  /**
   *  SetIconFamilyData()
   * Change the data of an icon family. The data is copied. The type can be one of the icon type, or 'PICT'. The data will be compressed if needed.
   *
   ...
   */
  EXTERN_API(OSErr)
  SetIconFamilyData(IconFamilyHandle iconFamily, OSType iconType, Handle h) TWOWORDINLINE(0x7030, 0xAA75);

  /**
   *  GetIconFamilyData()
   * Return a copy of the data in the icon family. The type can be one of the icon type, or 'PICT' The data will be returned uncompressed. The handle (h) will be resized as appropriate. If no data of the requested type is present, the handle size will be set to 0.
   *
   ...
   */
  EXTERN_API(OSErr)
  GetIconFamilyData(IconFamilyHandle iconFamily, OSType iconType, Handle h) TWOWORDINLINE(0x7031, 0xAA75);
  ...
  /**
   *  GetIconRefOwners()
   * This routine returns the reference count for the IconRef, or number of owners. A valid IconRef always has at least one owner.
   *
   ...
   */
  EXTERN_API(OSErr)
  GetIconRefOwners(IconRef theIconRef, UInt16 *owners) TWOWORDINLINE(0x700B, 0xAA75);
   ...
   * When the reference count reaches 0, all memory allocated for the icon is disposed. Any subsequent use of the IconRef is invalid.
   ...
   */
  EXTERN_API(OSErr)
  GetIconRefFromFile(const FSSpec *theFile, IconRef *theIconRef, SInt16 *theLabel) TWOWORDINLINE(0x7002, 0xAA75);
   ...
   */
  EXTERN_API(OSErr)
  GetIconRefFromFolder(SInt16 vRefNum, SInt32 parentFolderID, SInt32 folderID, SInt8 attributes, SInt8 accessPrivileges, IconRef *theIconRef) TWOWORDINLINE(0x7022, 0xAA75);
   ...
   */
  EXTERN_API(OSStatus)
  GetIconRefFromFileInfo(const FSRef *inRef, UniCharCount inFileNameLength, const UniChar *inFileName, /* can be NULL */ FSCatalogInfoBitmap inWhichInfo, const FSCatalogInfo *inCatalogInfo, /* can be NULL */ IconServicesUsageFlags inUsageFlags, IconRef *outIconRef, SInt16 *outLabel);

  /**
   * \name Adding and modifying IconRef
   */
   ...
   */
  EXTERN_API(OSErr)
  RegisterIconRefFromIconFamily(OSType creator, OSType iconType, IconFamilyHandle iconFamily, IconRef *theIconRef) TWOWORDINLINE(0x701C, 0xAA75);
   ...
   */
  EXTERN_API(OSErr)
  RegisterIconRefFromResource(OSType creator, OSType iconType, const FSSpec *resourceFile, SInt16 resourceID, IconRef *theIconRef) TWOWORDINLINE(0x7023, 0xAA75);
   ...
   */
  EXTERN_API(OSStatus)
  RegisterIconRefFromFSRef(OSType creator, OSType iconType, const FSRef *iconFile, IconRef *theIconRef);

  /**
   * UnregisterIconRef()
   * Removes the specified icon from the icon cache (if there are no users of it). If some clients are using this iconRef, then the IconRef will be removed when the last user calls ReleaseIconRef.
   *
   ...
   */
  EXTERN_API(OSErr)
  UnregisterIconRef(OSType creator, OSType iconType) TWOWORDINLINE(0x7008, 0xAA75);

  /**
   *  UpdateIconRef()
   * Call this routine to force an update of the data for iconRef.
   * For example after changing an icon in the desktop database or changing the custom icon of a file. Note that after _adding_ a custom icon to file or folder, you need to call GetIconRefFromFile() to get a new IconRef specific to this file.
   ...
   * This routines replaces the bitmaps of the specified IconRef with the ones in the specified resource file.
   ...
   */
  EXTERN_API(OSErr)
  OverrideIconRefFromResource(IconRef theIconRef, const FSSpec *resourceFile, SInt16 resourceID) TWOWORDINLINE(0x702A, 0xAA75);

  /**
   *  OverrideIconRef()
   *  This routines replaces the bitmaps of the specified IconRef with the ones from the new IconRef.
   *
   ...
   */
  EXTERN_API(OSErr)
  OverrideIconRef(IconRef oldIconRef, IconRef newIconRef) TWOWORDINLINE(0x702B, 0xAA75);

  /**
   *  RemoveIconRefOverride()
   *  This routine remove an override if one was applied to the icon and reverts back to the original bitmap data.
   *
  ...
  /**
   * \name Creating composite IconRef
   */
   ...
   */
  EXTERN_API(OSErr)
  CompositeIconRef(IconRef backgroundIconRef, IconRef foregroundIconRef, IconRef *compositeIconRef) TWOWORDINLINE(0x7014, 0xAA75);

  /**
   *  IsIconRefComposite()
   *  Indicates if a given icon ref is a composite of two other icon refs (and which ones) If it isn't a composite, backgroundIconRef and foreGroundIconRef will be 0.
   *
   *    \non_carbon_cfm   in IconServicesLib 8.5 and later
   *    \carbon_lib        in CarbonLib 1.0 and later
   *    \mac_os_x         in version 10.0 and later
   */
  EXTERN_API(OSErr)
  IsIconRefComposite(IconRef compositeIconRef, IconRef *backgroundIconRef, IconRef *foregroundIconRef) TWOWORDINLINE(0x701A, 0xAA75);

  /**
   * \section Using IconRef
   */
  ...
  /**
   *  PlotIconRef()
   * This routine plots the IconRef.  It mostly takes the same parameters as PlotIconSuite. Pass kIconServicesNormalUsageFlag as a default value for IconServicesUsageFlags.
   *
   ...
   */
  EXTERN_API(OSErr)
  PlotIconRef(const Rect *theRect, IconAlignmentType align, IconTransformType transform, IconServicesUsageFlags theIconServicesUsageFlags, IconRef theIconRef) TWOWORDINLINE(0x700E, 0xAA75);
   ...
   */
  EXTERN_API(OSStatus)
  PlotIconRefInContext(CGContextRef inContext, const CGRect *inRect, IconAlignmentType inAlign, IconTransformType inTransform, const RGBColor *inLabelColor, PlotIconRefFlags inFlags, IconRef inIconRef);

  /**
   *  PtInIconRef()
   *  This routine indicates if testPt would hit the icon designated by iconRef. It mostly takes the same parameters as PtInIconSuite. Pass kIconServicesNormalUsageFlag as a default value for IconServicesUsageFlags.
   *
   ...
   */
  EXTERN_API(Boolean)
  PtInIconRef(const Point *testPt, const Rect *iconRect, IconAlignmentType align, IconServicesUsageFlags theIconServicesUsageFlags, IconRef theIconRef) TWOWORDINLINE(0x700F, 0xAA75);

  /**
   *  RectInIconRef()
   *  This routine indicates if testRect would intersect the icon designated by iconRef. It mostly takes the same parameters as RectInIconSuite. Pass kIconServicesNormalUsageFlag as a default value for IconServicesUsageFlags.
   *
   ...
   */
  EXTERN_API(Boolean)
  RectInIconRef(const Rect *testRect, const Rect *iconRect, IconAlignmentType align, IconServicesUsageFlags iconServicesUsageFlags, IconRef theIconRef) TWOWORDINLINE(0x7010, 0xAA75);

  /**
   *  IconRefToRgn()
   *  This routine returns a region for the icon. It mostly takes the same parameters as IconSuiteToRgn. Pass kIconServicesNormalUsageFlag as a default value for IconServicesUsageFlags.
   *
   ...
   */
  EXTERN_API(OSErr)
  IconRefToRgn(RgnHandle theRgn, const Rect *iconRect, IconAlignmentType align, IconServicesUsageFlags iconServicesUsageFlags, IconRef theIconRef) TWOWORDINLINE(0x7011, 0xAA75);
   ...
   * \warning This is potentially an extremely expensive call as IconServices may be forced to attempt fetching the data for the IconRef's sizes/depths which may result in hitting the local disk or even the network to obtain the data to determine which sizes/depths actually exist. Pass kIconServicesNormalUsageFlag as a default value for IconServicesUsageFlags.
   *
   ...
   */
  EXTERN_API(OSErr)
  GetIconSizesFromIconRef(IconSelectorValue iconSelectorInput, IconSelectorValue *iconSelectorOutputPtr, IconServicesUsageFlags iconServicesUsageFlags, IconRef theIconRef) TWOWORDINLINE(0x7012, 0xAA75);

  /**
   * \name Flushing IconRef data
   */

  /**
   *  FlushIconRefs()
   * Making this call will dispose of all the data for the specified icons if the data can be reacquired, for example if the data is provided from a resource. '****' is a wildcard for all types or all creators.
   *
   ...
   */
  EXTERN_API(OSErr)
  FlushIconRefs(OSType creator, OSType iconType) TWOWORDINLINE(0x7029, 0xAA75);

  /**
   *  FlushIconRefsByVolume()
   * This routine disposes of the data for the icons related to the indicated volume if this data can be reacquired, for example if the data is provided from a resource.
   *
  ...
  */
   ...
   */
  EXTERN_API(OSErr)
  SetCustomIconsEnabled(SInt16 vRefNum, Boolean enableCustomIcons) TWOWORDINLINE(0x701F, 0xAA75);
   ...
   */
  EXTERN_API(OSErr)
  GetCustomIconsEnabled(SInt16 vRefNum, Boolean *customIconsEnabled) TWOWORDINLINE(0x7020, 0xAA75);
  ...
  /**
   *  GetIconRefVariant()
   * Icon variants allows different images to be used with different icon state. For example, the 'open' variant for a folder could be represented with an open folder. Given an icon ref and a desired variant, this routine returns an icon ref (which may be the same as the input icon ref) and a transformation which should be used with PlotIconRef() to render the icon appropriately. The returned icon ref should be used to do hit-testing.
   *
   ...
   */
  EXTERN_API(IconRef)
  GetIconRefVariant(IconRef inIconRef, OSType inVariant, IconTransformType *outTransform) TWOWORDINLINE(0x7034, 0xAA75);

  /**
   * \name Icon files (.icns files)
   */
   ...
   */
  EXTERN_API(OSErr)
  RegisterIconRefFromIconFile(OSType creator, OSType iconType, const FSSpec *iconFile, IconRef *theIconRef) TWOWORDINLINE(0x7035, 0xAA75);

  /**
   *  ReadIconFile()
   *  Read the specified icon file into the icon family handle. The caller is responsible for disposing the iconFamily
   ...
   */
  EXTERN_API(OSErr)
  ReadIconFile(const FSSpec *iconFile, IconFamilyHandle *iconFamily) TWOWORDINLINE(0x7036, 0xAA75);
   ...
   */
  EXTERN_API(OSErr)
  WriteIconFile(IconFamilyHandle iconFamily, const FSSpec *iconFile) TWOWORDINLINE(0x7037, 0xAA75);
