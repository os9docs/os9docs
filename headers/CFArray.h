/**
    ...
    \brief   CoreFoundation array collection
...
typedef CALLBACK_API_C(const void *,
                       CFArrayRetainCallBack)(CFAllocatorRef allocator,
                                              const void *value);
typedef CALLBACK_API_C(void, CFArrayReleaseCallBack)(CFAllocatorRef allocator,
                                                     const void *value);
typedef CALLBACK_API_C(CFStringRef,
                       CFArrayCopyDescriptionCallBack)(const void *value);
typedef CALLBACK_API_C(Boolean, CFArrayEqualCallBack)(const void *value1,
                                                      const void *value2);
...
struct CFArrayCallBacks {
   ...
   * parameter to the CFArray creation functions. This structure is
   * version 0.
   */
  CFIndex version;

  /**
   * The callback used to add a retain for the array on values as they
   * are put into the array. This callback returns the value to store
   * in the array, which is usually the value parameter passed to this
   * callback, but may be a different value if a different value should
   * be stored in the array. The array's allocator is passed as the
   * first argument.
   */
   ...
   * array from values as they are removed from the array. The array's
   ...
   * each value in the array. This is used by the CFCopyDescription()
   * function.
   */
 ...
 */
typedef CALLBACK_API_C(void, CFArrayApplierFunction)(const void *value,
                                                     void *context);
...
CFArrayCreate(CFAllocatorRef allocator, const void **values, CFIndex numValues,
