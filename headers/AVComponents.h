...
#pragma pack(2)
    ...
    */
    ...
    \**
            ame Component interface revision levels and history * /
        enum {
    ...
    \**
            ame Panel Standard component selectors * /
        enum {
    ...
    \**
            ame Engine Standard component selectors * /
        enum {
    ...
    \**
            ame Device Component Standard Component selectors * /
        enum {
    ...
    \**
            ame Panel Standard Component calls * /
#if CALL_NOT_IN_CARBON
        /**
                  *
    ...
    \**
            ame Port Component Standard Component selectors * /
#if CALL_NOT_IN_CARBON
        /**
                  *
    ...
    \**
            ame Video Out Port Component Selectors * /
        /**
                  *
    ...
    \**
            ame AV Device Component Selectors * /
#if CALL_NOT_IN_CARBON
        /**
                  *
    ...
    \**
            ame AV BackChannel Component Selectors * /
#if CALL_NOT_IN_CARBON
        /**
                  *
