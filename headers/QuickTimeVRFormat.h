...
#define kQTVRMinorVersion (0)
  ...
  /** \name Definitions and structures used in the VRWorld QTAtomContainer */
  ...
  /** \name Definitions and structures used in the Nodeinfo QTAtomContainer */
  ...
  /** \name Definitions and structures used in Panorama and Object tracks */
  ...
  struct QTVRPanoSampleAtom
  {
    ...
    UInt32 hotSpotRefTrackIndex; /* track reference index of the full res hot spot
                                    track*/
  ...
  */
  ...
  struct QTVRCubicFaceData
  {
    ...
    Float32 center[2];      /* Center of image relative to center of projection
                               (default = (0,0)) in normalized units*/
    Float32 aspect;         /* aspect>1 => tall pixels; aspect <1 => squat pixels (default
                               = 1)*/
  ...
  struct QTVRObjectSampleAtom
  {
    ...
    UInt16 defaultViewState;   /* The default view state number. The number must be
                                  1 to viewStateCount*/
    ...
    Float32 mouseMotionScale;  /* 180.0 for kStandardObject or kQTVRObjectInScene,
    ...
    Float32 defaultFieldOfView; /* must be in minFieldOfView and maxFieldOfView
                                   range inclusive*/
  ...
  /** \name QuickTime VR Authoring Components */
  ...
  */
  enum
  {
    kQTVRFlattenerManufacturer =
        FOUR_CHAR_CODE('vrwe'), /* aka QTVRFlattenerType*/
  ...
  enum
  {
    kQTVRFlattenerSettingsParentAtomType = FOUR_CHAR_CODE(
        'VRWe'), /* parent of settings atoms (other than compression)*/
    kQTVRFlattenerPreviewResAtomType =
        FOUR_CHAR_CODE('PRes'), /* preview resolution Int16*/
    kQTVRFlattenerImportSpecAtomType =
        FOUR_CHAR_CODE('ISpe'),                                   /* import file spec FSSpec*/
  ...
  enum
  {
    kQTVRSplitterSettingsParentAtomType = FOUR_CHAR_CODE(
        'VRSp'),                                                  /* parent of settings atoms (other than compression)*/
  ...
  enum
  {
    kQTVRObjExporterSettingsBlockSize =
        FOUR_CHAR_CODE('bsiz'), /* block size for compression*/
    kQTVRObjExporterSettingsTargetSize =
        FOUR_CHAR_CODE('tsiz') /* target file size*/
  };
