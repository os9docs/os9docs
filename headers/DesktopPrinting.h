/**
    ...
    \brief   Print driver declarations for classic PrintMonitor and Desktop
   PrintMonitor
...
#pragma pack(2)
  ...
  {
    short iOpCode; /** kDTPGetPrinterInfo, kDTPIsSamePrinterInfo or
  ...
  {
    kDTPBasicFeatures =
        0x00000000 /** only basic dtp funtionalities are supported*/
  };

  struct DTPInfoResource
  {
    long features;       /** kDTPBasicFeatures (only basic features are supported for
                            MacOS 8.5)*/
    long connectionType; /** can be kDTPUnknownConnection or any combination of
                            kDTPSerialConnection, */
    /** kDTPSCSIConnection, kDTPAppleTalkConnection, kDTPTCPIPConnection and
     * kDTPUSBConnection*/
  };
  ...
  enum
  {
    ...
    kDTPGestaltStructVersion2 =
        0x02008000,                        /** version 2.0f0 (for Mac OS 8.0, 8.1 and 7.x)*/
  ...
  struct DTPInfo
  {
    ...
    Str32 printerName; /** name of the acutal printer on the net (only for
                          LaserWriter 8 dtps)*/
    Str32 zoneName;    /** zone where this printer resides (only for LaserWriter 8
                          dtps)*/
  };
  ...
  enum
  {
    aeDTPSetDefaultEventType = FOUR_CHAR_CODE(
        'pfsd'), /** for setting a desktop printer to be the default*/
    aeDTPSyncEventType =
        FOUR_CHAR_CODE('pfsc') /** for notifying Desktop PrintMonitor of a new
                                  spool file created in a desktop printer folder*/
  };
  ...
  typedef CALLBACK_API(void,
                       DTPAsyncErrorNotificationProcPtr)(StringHandle errStr);
  ...
  typedef STACK_UPP_TYPE(DTPAsyncErrorNotificationProcPtr)
      DTPAsyncErrorNotificationUPP;
  ...
  enum
  {
    uppDTPAsyncErrorNotificationProcInfo = 0x000000C0
  }; /** pascal no_return_value Func(4_bytes) */
#ifdef __cplusplus
  inline DTPAsyncErrorNotificationUPP
  NewDTPAsyncErrorNotificationUPP(DTPAsyncErrorNotificationProcPtr userRoutine)
  {
    return (DTPAsyncErrorNotificationUPP)NewRoutineDescriptor(
...
#define NewDTPAsyncErrorNotificationUPP(userRoutine)                \
  ...
  enum
  {
    uppDTPEndNotificationProcInfo = 0x00000000
  }; /** pascal no_return_value Func() */
#ifdef __cplusplus
  inline DTPEndNotificationUPP
  NewDTPEndNotificationUPP(DTPEndNotificationProcPtr userRoutine)
  {
    return (DTPEndNotificationUPP)NewRoutineDescriptor(
        (ProcPtr)(userRoutine), uppDTPEndNotificationProcInfo,
        GetCurrentArchitecture());
  }
#else
#define NewDTPEndNotificationUPP(userRoutine)                                 \
  ...
  enum
  {
    uppDTPInForegroundProcInfo = 0x00000010
  }; /** pascal 1_byte Func() */
#ifdef __cplusplus
  inline DTPInForegroundUPP
  NewDTPInForegroundUPP(DTPInForegroundProcPtr userRoutine)
  {
    return (DTPInForegroundUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                                    uppDTPInForegroundProcInfo,
                                                    GetCurrentArchitecture());
  }
#else
#define NewDTPInForegroundUPP(userRoutine)                                     \
  ...
  enum
  {
    uppDTPStatusMessageProcInfo = 0x000000C0
  }; /** pascal no_return_value Func(4_bytes) */
#ifdef __cplusplus
  inline DTPStatusMessageUPP
  NewDTPStatusMessageUPP(DTPStatusMessageProcPtr userRoutine)
  {
    return (DTPStatusMessageUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
...
#else
#define DisposeDTPAsyncErrorNotificationUPP(userUPP) \
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeDTPEndNotificationUPP(DTPEndNotificationUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeDTPInForegroundUPP(DTPInForegroundUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeDTPStatusMessageUPP(DTPStatusMessageUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
#define DisposeDTPStatusMessageUPP(userUPP) DisposeRoutineDescriptor(userUPP)
  ...
  InvokeDTPAsyncErrorNotificationUPP(StringHandle errStr,
                                     DTPAsyncErrorNotificationUPP userUPP)
  {
    CALL_ONE_PARAMETER_UPP(userUPP, uppDTPAsyncErrorNotificationProcInfo, errStr);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void InvokeDTPEndNotificationUPP(DTPEndNotificationUPP userUPP)
  {
    CALL_ZERO_PARAMETER_UPP(userUPP, uppDTPEndNotificationProcInfo);
  }
#else
#define InvokeDTPEndNotificationUPP(userUPP) \
  CALL_ZERO_PARAMETER_UPP((userUPP), uppDTPEndNotificationProcInfo)
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline Boolean InvokeDTPInForegroundUPP(DTPInForegroundUPP userUPP)
  {
    return (Boolean)CALL_ZERO_PARAMETER_UPP(userUPP, uppDTPInForegroundProcInfo);
  }
#else
#define InvokeDTPInForegroundUPP(userUPP) \
  (Boolean) CALL_ZERO_PARAMETER_UPP((userUPP), uppDTPInForegroundProcInfo)
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void InvokeDTPStatusMessageUPP(StringHandle statusStr,
                                        DTPStatusMessageUPP userUPP)
  {
    CALL_ONE_PARAMETER_UPP(userUPP, uppDTPStatusMessageProcInfo, statusStr);
  }
#else
#define InvokeDTPStatusMessageUPP(statusStr, userUPP) \
  CALL_ONE_PARAMETER_UPP((userUPP), uppDTPStatusMessageProcInfo, (statusStr))
#endif
#endif
...
#define NewDTPAsyncErrorNotificationProc(userRoutine) \
  NewDTPAsyncErrorNotificationUPP(userRoutine)
#define NewDTPEndNotificationProc(userRoutine) \
  NewDTPEndNotificationUPP(userRoutine)
...
#define CallDTPAsyncErrorNotificationProc(userRoutine, errStr) \
  InvokeDTPAsyncErrorNotificationUPP(errStr, userRoutine)
#define CallDTPEndNotificationProc(userRoutine) \
  InvokeDTPEndNotificationUPP(userRoutine)
#define CallDTPInForegroundProc(userRoutine) \
  InvokeDTPInForegroundUPP(userRoutine)
#define CallDTPStatusMessageProc(userRoutine, statusStr) \
  InvokeDTPStatusMessageUPP(statusStr, userRoutine)
#endif /** CALL_NOT_IN_CARBON */

  /** PrGeneral call that PrintMonitor/Desktop PrintMonitor use to set up the
   * notification procs*/
  enum
  {
  ...
  /**
     ...
     for classic background printing and desktop printing that does not support
     third-party drivers
  */
  struct TPrintMonitorPrintingData
  {
    ...
    DTPInForegroundUPP
        pDTPInForegroundProc; /** UPP to check if PrintMonitor is in foreground*/
  };
  ...
  */
  struct TDesktopPrintMonitorPrintingData
  {
    ...
    DTPEndNotificationUPP
        pAsyncEndnotifyProc; /** UPP to take down the notification*/
    DTPInForegroundUPP
        pInForegroundProc; /** UPP to check if desktop printing is in foreground*/
    DTPStatusMessageUPP
        pStatusMessageProc; /** UPP to update the printing status message in the
                               desktop printer window*/
  };
  typedef struct TDesktopPrintMonitorPrintingData
      TDesktopPrintMonitorPrintingData;
  /** Spool file data*/
  ...
  */
  struct SpoolPREC126Record
  {
    ...
    OSType creator;  /** the creator type of the print driver that creates the
                        spool file*/
  ...
  struct SpoolPageIndex
  {
    ...
    long pageOffset[1]; /** the offset from the beginning of the file to the page
                           record*/
  ...
  */
  ...
  struct DTPPrintJobInfo
  {
    ...
    short numPages;            /** total number of pages in the spool file*/
    unsigned long timeToPrint; /** time to print (in seconds) when priority is
                                  kDTPPrintJobAtTime*/
    Str31 documentName;        /** name of the document*/
    Str31 applicationName;     /** name of the application that's used to create this
                                  spool file*/
    Str32 printerName;         /** name of the target printer (should be the same as
                                  what's in PREC 124)*/
  };
