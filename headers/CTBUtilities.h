/**
    ...
    \brief   Communications Toolbox Utilities interfaces.
...
#pragma pack(2)
  ...
  enum
  {
    uppDialogHookProcInfo = 0x000003A0
  }; /** pascal 2_bytes Func(2_bytes, 4_bytes) */
#ifdef __cplusplus
  inline DialogHookUPP NewDialogHookUPP(DialogHookProcPtr userRoutine)
  {
    return (DialogHookUPP)NewRoutineDescriptor(
...
#define NewDialogHookUPP(userRoutine)   \
  ...
  enum
  {
    uppNameFilterProcInfo = 0x000000E0
  }; /** pascal 2_bytes Func(4_bytes) */
#ifdef __cplusplus
  inline NameFilterUPP NewNameFilterUPP(NameFilterProcPtr userRoutine)
  {
    return (NameFilterUPP)NewRoutineDescriptor(
...
#define NewNameFilterUPP(userRoutine)   \
  ...
  enum
  {
    uppZoneFilterProcInfo = 0x000000E0
  }; /** pascal 2_bytes Func(4_bytes) */
#ifdef __cplusplus
  inline ZoneFilterUPP NewZoneFilterUPP(ZoneFilterProcPtr userRoutine)
  {
    return (ZoneFilterUPP)NewRoutineDescriptor(
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeDialogHookUPP(DialogHookUPP userUPP)
  {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeNameFilterUPP(NameFilterUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeZoneFilterUPP(ZoneFilterUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline short InvokeDialogHookUPP(short item, DialogRef theDialog,
                                   DialogHookUPP userUPP)
  {
    return (short)CALL_TWO_PARAMETER_UPP(userUPP, uppDialogHookProcInfo, item,
                                         theDialog);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline short InvokeNameFilterUPP(const EntityName *theEntity,
                                   NameFilterUPP userUPP)
  {
    return (short)CALL_ONE_PARAMETER_UPP(userUPP, uppNameFilterProcInfo,
                                         theEntity);
  }
#else
#define InvokeNameFilterUPP(theEntity, userUPP) \
  (short)CALL_ONE_PARAMETER_UPP((userUPP), uppNameFilterProcInfo, (theEntity))
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline short InvokeZoneFilterUPP(ConstStr32Param theZone,
                                   ZoneFilterUPP userUPP)
  {
    return (short)CALL_ONE_PARAMETER_UPP(userUPP, uppZoneFilterProcInfo, theZone);
  }
#else
#define InvokeZoneFilterUPP(theZone, userUPP) \
...
#define CallDialogHookProc(userRoutine, item, theDialog) \
  InvokeDialogHookUPP(item, theDialog, userRoutine)
#define CallNameFilterProc(userRoutine, theEntity) \
  InvokeNameFilterUPP(theEntity, userRoutine)
#define CallZoneFilterProc(userRoutine, theZone) \
  InvokeZoneFilterUPP(theZone, userRoutine)
#endif /** CALL_NOT_IN_CARBON */
   ...
   */
  short
  StandardNBP(Point where, ConstStr255Param prompt, short numTypes,
              NLType typeList, NameFilterUPP nameFilter, ZoneFilterUPP zoneFilter,
              DialogHookUPP hook, NBPReply *theReply);
   ...
   */
  short
  CustomNBP(Point where, ConstStr255Param prompt, short numTypes, NLType typeList,
            NameFilterUPP nameFilter, ZoneFilterUPP zoneFilter,
            DialogHookUPP hook, long userData, short dialogID,
            ModalFilterUPP filter, NBPReply *theReply);
...
#define NuLookup(where, prompt, numTypes, typeList, nameFilter, zoneFilter,    \
                 hook, theReply)                                               \
  StandardNBP(where, prompt, numTypes, typeList, nameFilter, zoneFilter, hook, \
              theReply)
#define NuPLookup(where, prompt, numTypes, typeList, nameFilter, zoneFilter, \
                  hook, userData, dialogID, filter, theReply)                \
  CustomNBP(where, prompt, numTypes, typeList, nameFilter, zoneFilter, hook, \
            userData, dialogID, filter, theReply)
