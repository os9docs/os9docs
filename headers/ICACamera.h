/**
    ...
    \brief   Digital still camera-specific selectors and structures
...
enum {
  ...
  kICAPropertyCameraBurstNumber =
      FOUR_CHAR_CODE('5018'), /** UInt16     enum/range*/
  kICAPropertyCameraBurstInterval =
      FOUR_CHAR_CODE('5019'), /** UInt16     enum/range*/
  kICAPropertyCameraTimelapseNumber =
      FOUR_CHAR_CODE('501A'), /** UInt16     enum/range*/
  kICAPropertyCameraTimelapseInterval =
      FOUR_CHAR_CODE('501B'), /** UInt32     enum/range*/
...
enum {
  ...
  kICAPropertyCameraStorageDescription =
      FOUR_CHAR_CODE('stod'), /** null terminated string*/
  kICAPropertyCameraVolumeLabel =
      FOUR_CHAR_CODE('voll') /** null terminated string*/
};
...
enum {
  ...
  kICAPropertyCameraSupportedMessages =
      FOUR_CHAR_CODE('msgs') /** array of OSTypes*/
};
