...
#define kPMDontWantBoolean                                                     \
  NULL                      /** for parameters which take a boolean reference */
...
enum {
  ...
  kPMMinSquareResolution =
      FOUR_CHAR_CODE('mins'), /** Min with X and Y resolution equal */
  kPMMaxSquareResolution =
      FOUR_CHAR_CODE('maxs'), /** Max with X and Y resolution equal */
  kPMDefaultResolution =
      FOUR_CHAR_CODE('dftr') /** printer default resolution */
};
...
enum {
  ...
  kPMColorModeSpecialColor =
      5 /** to allow for special colors such as metalic, light cyan, etc. */
};
...
enum {
  kPMColorIntentUndefined = 0x0000, /** User or application have not declared an
                                       intent, use the printer's default. */
  kPMColorIntentAutomatic = 0x0001, /** Automatically match for photos and
                                       graphics anywhere on the page. */
  kPMColorIntentPhoto =
      0x0002, /** Use Photographic (cmPerceptual) intent for all contents. */
  kPMColorIntentBusiness = 0x0004, /** Use Business Graphics (cmSaturation)
                                      intent for all contents. */
  kPMColorIntentRelColor =
      0x0008, /** Use Relative Colormetrics (Logo Colors) for the page. */
...
enum {
  ...
  kPMQualityDraft =
      0x0004, /** Print at highest speed, ink used is secondary consideration */
  kPMQualityNormal = 0x0008, /** Print in printers "general usage" mode for good
                                balance between quality and speed */
  kPMQualityPhoto = 0x000B, /** Optimize quality of photos on the page. Speed is
                               not a concern */
  kPMQualityBest =
      0x000D, /** Get best quality output for all objects and photos. */
  kPMQualityHighest =
      0x000F /** Absolute highest quality attained from a printers */
};
...
enum {
  ...
  kPMPaperTypeCoated =
      0x0002, /** Has a special coating for sharper images and text */
...
enum { kPMDuplexBindingLeftRight = 1, kPMDuplexBindingTopDown = 2 };
...
enum {
  ...
  kPSInjectionMaxDictSize =
      5 /** maximum size of a dictionary used for PSInjection */
};
...
enum {
  ...
  kPMInvalidParameter =
      paramErr, /** a required parameter is missing or invalid */
  ...
  kPMInvalidPrintSettings =
      -30875,                    /** the printsettings reference is invalid */
