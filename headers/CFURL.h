...
CFURLCreateWithBytes(CFAllocatorRef allocator, const UInt8 *URLBytes,
...
CFURLCreateData(CFAllocatorRef allocator, CFURLRef url,
                CFStringEncoding encoding, Boolean escapeWhitespace);
 ...
 */
EXTERN_API_C(CFURLRef)
CFURLCreateWithString(CFAllocatorRef allocator, CFStringRef URLString,
                      CFURLRef baseURL);
 ...
 */
EXTERN_API_C(CFURLRef)
CFURLCreateWithFileSystemPath(CFAllocatorRef allocator, CFStringRef filePath,
                              CFURLPathStyle pathStyle, Boolean isDirectory);
...
/** Creates a new URL by resolving the relative portion of relativeURL against
 * its base. */
/**
...
<scheme> "://" <net location> <path, always starting with slash> <add'l resource
specifiers>
 ...
 */
/** leading slash, and uses isAbsolute to report whether the URL's path is
 * absolute. */
/** CFURLCopyFileSystemPath() returns the URL's path as a file system path for
 * the */
/** given path style.  All percent escape sequences are replaced.  The URL is
 * not */
 ...
 */
EXTERN_API_C(CFStringRef)
CFURLCopyStrictPath(CFURLRef anURL, Boolean *isAbsolute);
 ...
 */
EXTERN_API_C(CFStringRef)
CFURLCopyFileSystemPath(CFURLRef anURL, CFURLPathStyle pathStyle);
 ...
 */
EXTERN_API_C(CFStringRef)
CFURLCopyParameterString(CFURLRef anURL, CFStringRef charactersToLeaveEscaped);
 ...
 */
EXTERN_API_C(CFStringRef)
CFURLCopyQueryString(CFURLRef anURL, CFStringRef charactersToLeaveEscaped);
 ...
 */
EXTERN_API_C(CFStringRef)
CFURLCopyFragment(CFURLRef anURL, CFStringRef charactersToLeaveEscaped);
 ...
 */
EXTERN_API_C(CFURLRef)
CFURLCreateCopyAppendingPathComponent(CFAllocatorRef allocator, CFURLRef url,
 ...
 */
EXTERN_API_C(CFURLRef)
CFURLCreateCopyAppendingPathExtension(CFAllocatorRef allocator, CFURLRef url,
 ...
 */
EXTERN_API_C(CFURLRef)
CFURLCreateCopyDeletingPathExtension(CFAllocatorRef allocator, CFURLRef url);
