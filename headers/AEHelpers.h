/**
    ...
    \brief   AEPrint, AEBuild and AEStream for Carbon

    \introduced_in  Mac OS X, CarbonLib
...
/**
   Create an AEDesc from the format string.  AEBuildError can be NULL, in which
   case no explicit error information will be returned.
*/
/**
 *  AEBuildDesc()
 *
...
AEBuildDesc(AEDesc *dst, AEBuildError *error, /** can be NULL */
            const char *src, ...);
 ...
 */
EXTERN_API_C(OSStatus)
vAEBuildDesc(AEDesc *dst, AEBuildError *error, /** can be NULL */
 ...
 */
EXTERN_API_C(OSStatus)
AEBuildParameters(AppleEvent *event, AEBuildError *error, /** can be NULL */
                  const char *format, ...);
 ...
 */
EXTERN_API_C(OSStatus)
vAEBuildParameters(AppleEvent *event, AEBuildError *error, /** can be NULL */
 ...
 */
EXTERN_API_C(OSStatus)
AEBuildAppleEvent(AEEventClass theClass, AEEventID theID, DescType addressType,
                  const void *addressData, long addressLength, short returnID,
 ...
 */
EXTERN_API_C(OSStatus)
vAEBuildAppleEvent(AEEventClass theClass, AEEventID theID, DescType addressType,
                   const void *addressData, long addressLength, short returnID,
                   long transactionID, AppleEvent *resultEvt,
                   AEBuildError *error, /** can be NULL */
                   const char *paramsFmt, va_list args);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamClose(AEStreamRef ref, AEDesc *desc);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamOpenDesc(AEStreamRef ref, DescType newType);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamWriteData(AEStreamRef ref, const void *data, Size length);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamWriteDesc(AEStreamRef ref, DescType newType, const void *data,
                  Size length);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamWriteAEDesc(AEStreamRef ref, const AEDesc *desc);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamOpenRecord(AEStreamRef ref, DescType newType);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamSetRecordType(AEStreamRef ref, DescType newType);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamWriteKeyDesc(AEStreamRef ref, AEKeyword key, DescType newType,
                     const void *data, Size length);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamOpenKeyDesc(AEStreamRef ref, AEKeyword key, DescType newType);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamWriteKey(AEStreamRef ref, AEKeyword key);
 ...
 */
EXTERN_API_C(AEStreamRef)
AEStreamCreateEvent(AEEventClass clazz, AEEventID id, DescType targetType,
                    const void *targetData, long targetLength, short returnID,
                    long transactionID);
 ...
 */
EXTERN_API_C(OSStatus)
AEStreamOptionalParam(AEStreamRef ref, AEKeyword key);
