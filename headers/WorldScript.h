...
enum {
  WSILookupSimpleArray = 0,   // a simple array indexed by glyph code   WSILookupSegmentSingle = 2, // segment mapping to single value   WSILookupSegmentArray = 4,  // segment mapping to lookup array   WSILookupSingleTable = 6,   // sorted list of glyph, value pairs   WSILookupTrimmedArray = 8   // a simple trimmed array indexed by glyph code };
...
// Glyph-to-Character constants and types  enum { kCurrentGlyphToCharVersion = 0x00010100 };

typedef unsigned short GlyphToCharLookupFormats;
enum {// state, class and actions tables follow here... 
...
enum {
  wsiStartOfLineState = 0, // pre-defined states   wsiStartOfRunState = 1,
...
// pre-defined states 
// Line Layout's Property table version <11> enum {
