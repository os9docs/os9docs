...
/* JUSTIFICATION TYPES
   ...
   justification table's state table.
   ...
   why the number of spaces per inserting string is specified in the
   justification table.
...
struct WSIJustificationStateEntry {
  WSIJustificationPriority
      markPriority; /* non-zero priorities means insertion */
...
/* pass as priorityWeight to JustifyWSILayout to use script's current just
 * setting */
