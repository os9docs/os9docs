/**
    ...
    \brief   QuickDraw GX error constants and debugging routines
...
#pragma pointers_in_D0
  ...
  enum
  {
    ...
    clip_to_frame_shape_unimplemented =
        gxFirstSystemDebuggingError + 1, /** font parameter debugging errors */
    ...
    illegal_font_attributes =
        gxFirstSystemDebuggingError + 4, /** parameter debugging errors */
    ...
    unknown_font_table_format =
        ...
        27, /** the styles encoding is not present in the font */
  ...
  enum
  {
    ...
    style_run_array_does_not_match_number_of_characters =
        gxFirstSystemDebuggingError + 49,
    ...
    graphic_type_does_not_have_multiple_contours =
        gxFirstSystemDebuggingError + 65,
    ...
    cannot_set_unique_items_attribute_when_picture_contains_items =
        gxFirstSystemDebuggingError + 81,
    layer_style_cannot_contain_a_face = gxFirstSystemDebuggingError + 82,
    layer_glyph_shape_cannot_contain_nil_styles = gxFirstSystemDebuggingError + 83
  };
  ...
  enum
  {
    ...
    port_wrong_type = gxFirstSystemDebuggingError + 90
  };
  ...
  enum
  {
    ...
    recursive_caches = gxFirstSystemDebuggingError + 109
  };
  ...
  enum
  {
    ...
    recursive_fillShapes = gxFirstSystemDebuggingError + 111
  };
  ...
  enum
  {
    ...
    bad_address = gxFirstSystemDebuggingError + 115
  };
  ...
  enum
  {
    ...
    bad_private_flags = gxFirstSystemDebuggingError + 122
  };
  ...
  enum
  {
    ...
    invalid_contour_count = gxFirstSystemDebuggingError + 124
  };
  ...
  enum
  {
    ...
    bitmap_rowBytes_must_be_specified_for_user_image_buffer =
        gxFirstSystemDebuggingError + 133
  };
  ...
  enum
  {
    ...
    invalid_bitImage_internal_flag = gxFirstSystemDebuggingError + 137
  };
  ...
  enum
  {
    ...
    text_index_cache_wrong_size = gxFirstSystemDebuggingError + 140
  };
  ...
  enum
  {
    ...
    glyph_run_counts_do_not_sum_to_character_count =
        gxFirstSystemDebuggingError + 143,
    glyph_first_advance_bit_set_not_allowed = gxFirstSystemDebuggingError + 144,
    glyph_tangent_vectors_both_zero = gxFirstSystemDebuggingError + 145
  };
  ...
  enum
  {
    ...
    layout_run_lengths_do_not_sum_to_text_length =
        gxFirstSystemDebuggingError + 149
  };
  ...
  enum
  {
    ...
    invalid_picture_count = gxFirstSystemDebuggingError + 156
  };
  ...
  enum
  {
    ...
    bad_transform_in_textFace = gxFirstSystemDebuggingError + 160
  };
  ...
  enum
  {
    ...
    transform_clip_missing = gxFirstSystemDebuggingError + 162
  };
  ...
  enum
  {
    ...
    metrics_not_in_metrics_list = gxFirstSystemDebuggingError + 178
  };
  ...
  enum
  {
    ...
    invalid_bitmap_in_device = gxFirstSystemDebuggingError + 184
  };
  ...
  enum
  {
    ...
    invalid_colorSet_count = gxFirstSystemDebuggingError + 188
  };
  ...
  enum
  {
    ...
    invalid_colorProfile_response_count = gxFirstSystemDebuggingError + 191
  };
  ...
  enum
  {
    ...
    font_scaler_no_kerning_applied =
        gxFirstFontScalerWarning + 4, /** might not be what you expected */
    ...
    font_not_found_during_unflattening =
        gxFirstFontScalerWarning + 8, /**storage */
  ...
  enum
  {
    ...
    unable_to_traverse_open_contour_that_starts_or_ends_off_the_curve =
        gxFirstSystemDebuggingWarning + 5,
    unable_to_draw_open_contour_that_starts_or_ends_off_the_curve =
        gxFirstSystemDebuggingWarning + 6,
  ...
  enum
  {
    ...
    union_of_area_and_length_returns_area_only =
        gxFirstSystemDebuggingWarning + 17,
    insufficient_coordinate_space_for_new_device =
        gxFirstSystemDebuggingWarning + 18
  };
  ...
  typedef CALLBACK_API_C(void, gxUserErrorProcPtr)(gxGraphicsError status,
                                                   long refcon);
  typedef CALLBACK_API_C(void, gxUserWarningProcPtr)(gxGraphicsWarning status,
                                                     long refcon);
  typedef CALLBACK_API_C(void, gxUserNoticeProcPtr)(gxGraphicsNotice status,
                                                    long refcon);
  ...
  enum
  {
    uppgxUserErrorProcInfo = 0x000003C1
  }; /** no_return_value Func(4_bytes, 4_bytes) */
#ifdef __cplusplus
  inline gxUserErrorUPP NewgxUserErrorUPP(gxUserErrorProcPtr userRoutine)
  {
    return (gxUserErrorUPP)NewRoutineDescriptor(
        (ProcPtr)(userRoutine), uppgxUserErrorProcInfo, GetCurrentArchitecture());
  }
#else
#define NewgxUserErrorUPP(userRoutine)                                     \
  (gxUserErrorUPP)                                                         \
      NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxUserErrorProcInfo, \
  ...
  enum
  {
    uppgxUserWarningProcInfo = 0x000003C1
  }; /** no_return_value Func(4_bytes, 4_bytes) */
#ifdef __cplusplus
  inline gxUserWarningUPP NewgxUserWarningUPP(gxUserWarningProcPtr userRoutine)
  {
    return (gxUserWarningUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                                  uppgxUserWarningProcInfo,
                                                  GetCurrentArchitecture());
  }
#else
#define NewgxUserWarningUPP(userRoutine)                                     \
  (gxUserWarningUPP)                                                         \
      NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxUserWarningProcInfo, \
                           GetCurrentArchitecture())
#endif
#endif
  ...
  enum
  {
    uppgxUserNoticeProcInfo = 0x000003C1
  }; /** no_return_value Func(4_bytes, 4_bytes) */
#ifdef __cplusplus
  inline gxUserNoticeUPP NewgxUserNoticeUPP(gxUserNoticeProcPtr userRoutine)
  {
    return (gxUserNoticeUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                                 uppgxUserNoticeProcInfo,
                                                 GetCurrentArchitecture());
  }
#else
#define NewgxUserNoticeUPP(userRoutine)                                     \
  (gxUserNoticeUPP)                                                         \
      NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxUserNoticeProcInfo, \
                           GetCurrentArchitecture())
#endif
#endif

  /**
   *  DisposegxUserErrorUPP()
   *
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposegxUserErrorUPP(gxUserErrorUPP userUPP)
  {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposegxUserWarningUPP(gxUserWarningUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposegxUserNoticeUPP(gxUserNoticeUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void InvokegxUserErrorUPP(gxGraphicsError status, long refcon,
                                   gxUserErrorUPP userUPP)
  {
    CALL_TWO_PARAMETER_UPP(userUPP, uppgxUserErrorProcInfo, status, refcon);
  }
#else
#define InvokegxUserErrorUPP(status, refcon, userUPP) \
  CALL_TWO_PARAMETER_UPP((userUPP), uppgxUserErrorProcInfo, (status), (refcon))
#endif
#endif

  /**
   *  InvokegxUserWarningUPP()
   *
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void InvokegxUserWarningUPP(gxGraphicsWarning status, long refcon,
                                     gxUserWarningUPP userUPP)
  {
    CALL_TWO_PARAMETER_UPP(userUPP, uppgxUserWarningProcInfo, status, refcon);
  }
#else
#define InvokegxUserWarningUPP(status, refcon, userUPP)                 \
  CALL_TWO_PARAMETER_UPP((userUPP), uppgxUserWarningProcInfo, (status), \
                         (refcon))
#endif
#endif

  /**
   *  InvokegxUserNoticeUPP()
   *
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void InvokegxUserNoticeUPP(gxGraphicsNotice status, long refcon,
                                    gxUserNoticeUPP userUPP)
  {
    CALL_TWO_PARAMETER_UPP(userUPP, uppgxUserNoticeProcInfo, status, refcon);
  }
#else
#define InvokegxUserNoticeUPP(status, refcon, userUPP) \
  CALL_TWO_PARAMETER_UPP((userUPP), uppgxUserNoticeProcInfo, (status), (refcon))
#endif
#endif
...
#define CallgxUserErrorProc(userRoutine, status, refcon) \
  InvokegxUserErrorUPP(status, refcon, userRoutine)
#define CallgxUserWarningProc(userRoutine, status, refcon) \
  InvokegxUserWarningUPP(status, refcon, userRoutine)
#define CallgxUserNoticeProc(userRoutine, status, refcon) \
  InvokegxUserNoticeUPP(status, refcon, userRoutine)
#endif /** CALL_NOT_IN_CARBON */
  ...
  enum
  {
    ...
    gxApBlockValidation = 0x0100,   /** check the relevant block structures after
   ...
   */
  gxDrawError
  GXGetShapeDrawError(gxShape source);
   ...
   */
  void
  GXValidateColorSet(gxColorSet target);
   ...
   */
  void
  GXValidateShape(gxShape target);
   ...
   */
  void
  GXValidateStyle(gxStyle target);
   ...
   */
  void
  GXValidateTransform(gxTransform target);
   ...
   */
  void
  GXValidateViewPort(gxViewPort target);
   ...
   */
  void
  GXValidateViewGroup(gxViewGroup target);
