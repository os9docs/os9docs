...
*/
   ...
   */
  OSErr
  CSVendorSpecific(VendorSpecificPB *pb);
   ...
   */
  OSErr
  CSRegisterClient(RegisterClientPB *pb);
   ...
   */
  OSErr
  CSDeregisterClient(RegisterClientPB *pb);
   ...
   */
  OSErr
  CSGetCardServicesInfo(GetCardServicesInfoPB *pb);
   ...
   */
  OSErr
  CSValidateCIS(ValidateCISPB *pb);
   ...
   */
  OSErr
  CSGetFirstClient(GetClientPB *pb);
   ...
   */
  OSErr
  CSGetNextClient(GetClientPB *pb);
   ...
   */
  OSErr
  CSGetClientInfo(GetClientInfoPB *pb);
   ...
   */
  OSErr
  CSRequestWindow(ReqModRelWindowPB *pb);
   ...
   */
  OSErr
  CSModifyWindow(ReqModRelWindowPB *pb);
   ...
   */
  OSErr
  CSReleaseWindow(ReqModRelWindowPB *pb);
   ...
   */
  OSErr
  CSGetClientEventMask(GetSetClientEventMaskPB *pb);
   ...
   */
  OSErr
  CSSetClientEventMask(GetSetClientEventMaskPB *pb);
   ...
   */
  OSErr
  CSRequestSocketMask(ReqRelSocketMaskPB *pb);
   ...
   */
  OSErr
  CSReleaseSocketMask(ReqRelSocketMaskPB *pb);
