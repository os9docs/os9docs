 ...
 */
   ...
   */
  OSErr
  UTDisposeVCB(VCBPtr volCtrlBlockPtr);
   ...
   */
  OSErr
  UTAllocateWDCB(WDPBPtr paramBlock);
   ...
   */
  OSErr
  UTGetDefaultVol(WDPBPtr paramBlock);
   ...
   */
  OSErr
  UTEjectVol(VCBPtr volCtrlBlockPtr);
   ...
   */
  OSErr
  UTCheckWDRefNum(short wdRefNum);
   ...
   */
  OSErr
  UTCheckFileRefNum(short fileRefNum);
   ...
   */
  OSErr
  UTCheckVolRefNum(short vRefNum);
   ...
   */
  OSErr
  UTCheckVolOffline(short vRefNum);
   ...
   */
  OSErr
  UTCheckVolModifiable(short vRefNum);
   ...
   */
  OSErr
  UTCheckFileModifiable(short fileRefNum);
   ...
   */
  OSErr
  UTGetPathComponentName(ParsePathRecPtr parseRec);
   ...
   */
  OSErr
  UTReleaseBlock(Ptr buffer, short rbOption);
   ...
   */
  OSErr
  UTFlushCache(short refNum, short fcOption);
   ...
   */
  OSErr
  UTTrashVolBlocks(VCBPtr volCtrlBlockPtr);
   ...
   */
  OSErr
  UTCheckFCB(FCBRecPtr fileCtrlBlockPtr);
   ...
   */
  OSErr
  UTAddFCBToSearchList(FCBRecPtr fileCtrlBlockPtr);
   ...
   */
  OSErr
  UTGetForkControlBlockSize(UInt32 *fcbSize);
