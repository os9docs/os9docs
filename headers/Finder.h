...
#pragma pack(2)
  ...
  */
  ...
  struct FInfo
  {
    OSType fdType;          /**< Set if the file contains routing info resource */
  ...
  // In MacOS 8, the fdIconID and fdComment fields were changed to become reserved fields for the Finder.The fdScript has become an extended flag.
  ...
  */
  ...
  // Folder info
  /**  The position and dimension of the folder 's window IMPORTANT : // ex. kIsInvisible, kNameLocked, etc. In MacOS 8, the f // Folder' s location in the parent folder
