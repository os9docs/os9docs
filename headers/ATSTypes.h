/**
    ...
    \brief   Public interfaces for Apple Type Services components.
...
struct ATSFontMetrics {
  ...
  Float32 ascent; /* Maximum height above baseline reached by the glyphs in the
                     font */
  /* or maximum distance to the right of the centerline reached by the glyphs in
   * the font */
  Float32 descent; /* Maximum depth below baseline reached by the glyphs in the
                      font */
