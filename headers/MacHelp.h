/**
    ...
    \brief   Macintosh Help Package Interfaces.

    \introduced_in  Mac OS X/CarbonLib 1.3
...
/**����������������������������������������������������������������������������������*/
enum { kMacHelpVersion = 0x0003 };

typedef SInt16 HMContentRequest;
enum { kHMSupplyContent = 0, kHMDisposeContent = 1 };
...
enum {
  ...
  kHMTEHandleContent = FOUR_CHAR_CODE('txth'), /** NOT SUPPORTED ON MAC OS X*/
  kHMTextResContent = FOUR_CHAR_CODE('text'),  /** NOT SUPPORTED ON MAC OS X*/
...
enum {
  kHMMinimumContentIndex =
      0, /** first entry in HMHelpContentRec.content is the minimum content */
  kHMMaximumContentIndex =
      1 /** second entry in HMHelpContentRec.content is the maximum content */
};

enum {
  errHMIllegalContentForMinimumState =
      -10980, /** unrecognized content type for minimum content */
  errHMIllegalContentForMaximumState =
      -10981 /** unrecognized content type for maximum content */
};

/** obsolete names; will be removed*/
enum { kHMIllegalContentForMinimumState = errHMIllegalContentForMinimumState };

enum { kHelpTagEventHandlerTag = FOUR_CHAR_CODE('hevt') };
...
/**������������������������������������������������������������������������������������������
 */
typedef CALLBACK_API(OSStatus, HMControlContentProcPtr)(
    ControlRef inControl, Point inGlobalMouse, HMContentRequest inRequest,
    HMContentProvidedType *outContentProvided, HMHelpContentPtr ioHelpContent);
typedef CALLBACK_API(OSStatus, HMWindowContentProcPtr)(
    WindowRef inWindow, Point inGlobalMouse, HMContentRequest inRequest,
    HMContentProvidedType *outContentProvided, HMHelpContentPtr ioHelpContent);
typedef CALLBACK_API(OSStatus, HMMenuTitleContentProcPtr)(
    MenuRef inMenu, HMContentRequest inRequest,
    HMContentProvidedType *outContentProvided, HMHelpContentPtr ioHelpContent);
typedef CALLBACK_API(OSStatus, HMMenuItemContentProcPtr)(
    const MenuTrackingData *inTrackingData, HMContentRequest inRequest,
    HMContentProvidedType *outContentProvided, HMHelpContentPtr ioHelpContent);
...
#if !OPAQUE_UPP_TYPES
enum {
  uppHMControlContentProcInfo = 0x0000FBF0
}; /** pascal 4_bytes Func(4_bytes, 4_bytes, 2_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
inline HMControlContentUPP
NewHMControlContentUPP(HMControlContentProcPtr userRoutine) {
  return (HMControlContentUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                                   uppHMControlContentProcInfo,
                                                   GetCurrentArchitecture());
}
#else
#define NewHMControlContentUPP(userRoutine)                                    \
  (HMControlContentUPP) NewRoutineDescriptor((ProcPtr)(userRoutine),           \
                                             uppHMControlContentProcInfo,      \
                                             GetCurrentArchitecture())
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
enum {
  uppHMWindowContentProcInfo = 0x0000FBF0
}; /** pascal 4_bytes Func(4_bytes, 4_bytes, 2_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
inline HMWindowContentUPP
NewHMWindowContentUPP(HMWindowContentProcPtr userRoutine) {
  return (HMWindowContentUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                                  uppHMWindowContentProcInfo,
                                                  GetCurrentArchitecture());
}
#else
#define NewHMWindowContentUPP(userRoutine)                                     \
  (HMWindowContentUPP)                                                         \
      NewRoutineDescriptor((ProcPtr)(userRoutine), uppHMWindowContentProcInfo, \
                           GetCurrentArchitecture())
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
enum {
  uppHMMenuTitleContentProcInfo = 0x00003EF0
}; /** pascal 4_bytes Func(4_bytes, 2_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
inline HMMenuTitleContentUPP
NewHMMenuTitleContentUPP(HMMenuTitleContentProcPtr userRoutine) {
  return (HMMenuTitleContentUPP)NewRoutineDescriptor(
      (ProcPtr)(userRoutine), uppHMMenuTitleContentProcInfo,
      GetCurrentArchitecture());
}
#else
#define NewHMMenuTitleContentUPP(userRoutine)                                  \
  (HMMenuTitleContentUPP) NewRoutineDescriptor((ProcPtr)(userRoutine),         \
                                               uppHMMenuTitleContentProcInfo,  \
                                               GetCurrentArchitecture())
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
enum {
  uppHMMenuItemContentProcInfo = 0x00003EF0
}; /** pascal 4_bytes Func(4_bytes, 2_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
inline HMMenuItemContentUPP
NewHMMenuItemContentUPP(HMMenuItemContentProcPtr userRoutine) {
  return (HMMenuItemContentUPP)NewRoutineDescriptor(
      (ProcPtr)(userRoutine), uppHMMenuItemContentProcInfo,
      GetCurrentArchitecture());
}
#else
#define NewHMMenuItemContentUPP(userRoutine)                                   \
  (HMMenuItemContentUPP) NewRoutineDescriptor((ProcPtr)(userRoutine),          \
                                              uppHMMenuItemContentProcInfo,    \
                                              GetCurrentArchitecture())
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeHMControlContentUPP(HMControlContentUPP userUPP) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeHMWindowContentUPP(HMWindowContentUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeHMMenuTitleContentUPP(HMMenuTitleContentUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeHMMenuItemContentUPP(HMMenuItemContentUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
InvokeHMControlContentUPP(ControlRef inControl, Point inGlobalMouse,
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline OSStatus InvokeHMControlContentUPP(
    ControlRef inControl, Point inGlobalMouse, HMContentRequest inRequest,
    HMContentProvidedType *outContentProvided, HMHelpContentPtr ioHelpContent,
    HMControlContentUPP userUPP) {
  return (OSStatus)CALL_FIVE_PARAMETER_UPP(userUPP, uppHMControlContentProcInfo,
                                           inControl, inGlobalMouse, inRequest,
                                           outContentProvided, ioHelpContent);
}
#else
#define InvokeHMControlContentUPP(inControl, inGlobalMouse, inRequest,         \
                                  outContentProvided, ioHelpContent, userUPP)  \
  (OSStatus) CALL_FIVE_PARAMETER_UPP(                                          \
      (userUPP), uppHMControlContentProcInfo, (inControl), (inGlobalMouse),    \
      (inRequest), (outContentProvided), (ioHelpContent))
#endif
#endif
 ...
 */
EXTERN_API_C(OSStatus)
InvokeHMWindowContentUPP(WindowRef inWindow, Point inGlobalMouse,
                         HMContentRequest inRequest,
                         HMContentProvidedType *outContentProvided,
                         HMHelpContentPtr ioHelpContent,
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline OSStatus InvokeHMWindowContentUPP(
    WindowRef inWindow, Point inGlobalMouse, HMContentRequest inRequest,
    HMContentProvidedType *outContentProvided, HMHelpContentPtr ioHelpContent,
    HMWindowContentUPP userUPP) {
  return (OSStatus)CALL_FIVE_PARAMETER_UPP(userUPP, uppHMWindowContentProcInfo,
                                           inWindow, inGlobalMouse, inRequest,
                                           outContentProvided, ioHelpContent);
}
#else
#define InvokeHMWindowContentUPP(inWindow, inGlobalMouse, inRequest,           \
                                 outContentProvided, ioHelpContent, userUPP)   \
  (OSStatus) CALL_FIVE_PARAMETER_UPP((userUPP), uppHMWindowContentProcInfo,    \
                                     (inWindow), (inGlobalMouse), (inRequest), \
                                     (outContentProvided), (ioHelpContent))
#endif
#endif
 ...
 */
EXTERN_API_C(OSStatus)
InvokeHMMenuTitleContentUPP(MenuRef inMenu, HMContentRequest inRequest,
                            HMContentProvidedType *outContentProvided,
                            HMHelpContentPtr ioHelpContent,
...
InvokeHMMenuTitleContentUPP(MenuRef inMenu, HMContentRequest inRequest,
                            ...
                            HMHelpContentPtr ioHelpContent,
                            HMMenuTitleContentUPP userUPP) {
  return (OSStatus)CALL_FOUR_PARAMETER_UPP(
      userUPP, uppHMMenuTitleContentProcInfo, inMenu, inRequest,
      outContentProvided, ioHelpContent);
}
#else
#define InvokeHMMenuTitleContentUPP(inMenu, inRequest, outContentProvided,     \
                                    ioHelpContent, userUPP)                    \
  (OSStatus) CALL_FOUR_PARAMETER_UPP((userUPP), uppHMMenuTitleContentProcInfo, \
                                     (inMenu), (inRequest),                    \
                                     (outContentProvided), (ioHelpContent))
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline OSStatus InvokeHMMenuItemContentUPP(
    const MenuTrackingData *inTrackingData, HMContentRequest inRequest,
    HMContentProvidedType *outContentProvided, HMHelpContentPtr ioHelpContent,
    HMMenuItemContentUPP userUPP) {
  return (OSStatus)CALL_FOUR_PARAMETER_UPP(
      userUPP, uppHMMenuItemContentProcInfo, inTrackingData, inRequest,
      outContentProvided, ioHelpContent);
}
#else
#define InvokeHMMenuItemContentUPP(inTrackingData, inRequest,                  \
                                   outContentProvided, ioHelpContent, userUPP) \
  (OSStatus) CALL_FOUR_PARAMETER_UPP((userUPP), uppHMMenuItemContentProcInfo,  \
                                     (inTrackingData), (inRequest),            \
                                     (outContentProvided), (ioHelpContent))
#endif
#endif
...
#define NewHMMenuTitleContentProc(userRoutine)                                 \
  NewHMMenuTitleContentUPP(userRoutine)
#define NewHMMenuItemContentProc(userRoutine)                                  \
  NewHMMenuItemContentUPP(userRoutine)
#define CallHMControlContentProc(userRoutine, inControl, inGlobalMouse,        \
                                 inRequest, outContentProvided, ioHelpContent) \
  InvokeHMControlContentUPP(inControl, inGlobalMouse, inRequest,               \
                            outContentProvided, ioHelpContent, userRoutine)
#define CallHMWindowContentProc(userRoutine, inWindow, inGlobalMouse,          \
                                inRequest, outContentProvided, ioHelpContent)  \
  InvokeHMWindowContentUPP(inWindow, inGlobalMouse, inRequest,                 \
                           outContentProvided, ioHelpContent, userRoutine)
#define CallHMMenuTitleContentProc(userRoutine, inMenu, inRequest,             \
                                   outContentProvided, ioHelpContent)          \
  InvokeHMMenuTitleContentUPP(inMenu, inRequest, outContentProvided,           \
                              ioHelpContent, userRoutine)
#define CallHMMenuItemContentProc(userRoutine, inTrackingData, inRequest,      \
                                  outContentProvided, ioHelpContent)           \
 ...
 */
EXTERN_API(OSStatus)
HMGetHelpMenu(MenuRef *outHelpMenu,
 ...
 */
EXTERN_API(OSStatus)
HMGetControlHelpContent(ControlRef inControl, HMHelpContentRec *outContent);
 ...
 */
EXTERN_API(OSStatus)
HMSetWindowHelpContent(WindowRef inWindow, const HMHelpContentRec *inContent);
 ...
 */
EXTERN_API(OSStatus)
HMGetWindowHelpContent(WindowRef inWindow, HMHelpContentRec *outContent);
 ...
 */
EXTERN_API(OSStatus)
HMSetMenuItemHelpContent(MenuRef inMenu, MenuItemIndex inItem,
                         const HMHelpContentRec *inContent);
 ...
 */
EXTERN_API(OSStatus)
HMGetMenuItemHelpContent(MenuRef inMenu, MenuItemIndex inItem,
 ...
 */
EXTERN_API(OSStatus)
HMSetMenuHelpFromBalloonRsrc(MenuRef inMenu, SInt16 inHmnuRsrcID);
 ...
 */
EXTERN_API(OSStatus)
HMSetDialogHelpFromBalloonRsrc(DialogRef inDialog, SInt16 inHdlgRsrcID,
                               SInt16 inItemStart);
