/**
    ...
    \brief   Processor Exception Handling Interfaces.
...
#pragma pack(2)
  ...
  enum
  {
    ...
    kStackOverflowException = 14,   /** Optional, may be implemented as
                                       kAccessException on some systems.*/
    kTaskTerminationException = 15, /** Obsolete*/
    kTaskCreationException = 16,    /** Obsolete*/
    kDataAlignmentException =
        17 /** May occur when a task is in little endian mode or created with
              kMPTaskTakesAllExceptions.*/
  };
  ...
  enum
  {
    ...
    illegalInstructionException =
        kIllegalInstructionException,                   /** Obsolete name*/
    ...
    unresolvablePageFaultException =
        kUnresolvablePageFaultException, /** Obsolete name*/
    privilegeViolationException =
        kPrivilegeViolationException, /** Obsolete name*/
    traceException = kTraceException, /** Obsolete name*/
    instructionBreakpointException =
        kInstructionBreakpointException,                /** Obsolete name*/
  ...
  */
  ...
  enum
  {
    uppExceptionHandlerProcInfo = 0x000000F1
  }; /** 4_bytes Func(4_bytes) */
#ifdef __cplusplus
  inline ExceptionHandlerUPP
  NewExceptionHandlerUPP(ExceptionHandlerProcPtr userRoutine)
  {
    return userRoutine;
  }
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline OSStatus InvokeExceptionHandlerUPP(ExceptionInformation *theException,
                                            ExceptionHandlerUPP userUPP)
  {
    return (*userUPP)(theException);
  }
#else
#define InvokeExceptionHandlerUPP(theException, userUPP) \
  (*userUPP)(theException)
#endif
#endif
