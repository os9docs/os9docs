...
enum {
  ...
  _AliasDispatch =
      0xA823, /** Device Manager (some shared by the File Manager) */
  _Open = 0xA000,
  _Close = 0xA001,
  _Read = 0xA002,
  _Write = 0xA003,
  ...
  _HGetVol = 0xA214,
  _HSetFLock = 0xA241,
  _HRstFLock = 0xA242, /** dispatch trap for remaining File Manager (and Desktop
                          Manager) calls*/
  _FSDispatch = 0xA060,
...
enum {
  ...
  _HFSUtilDispatch =
      0xA824 /** HFS Utility routines in the File System Manager*/
};
