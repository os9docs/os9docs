...
/** The _reserved field is part of the Microsoft COM binary standard on
 * Macintosh. */
/** You can declare new C struct interfaces by defining a new struct that
 * includes "IUNKNOWN_C_GUTS;" before the first field of the struct. */
...
/** This macro should be used when defining all interface functions (as it is
 * for the IUnknown functions below). */
#define STDMETHODCALLTYPE

/** The __RPC_FAR macro is for COM source compatibility only. This macro is used
 * a lot in COM interface definitions.  If your CFPlugIn interfaces need to be
 * COM interfaces as well, you can use this macro to get better source
 * compatibility.  It is not used in the IUnknown definition below, because when
 * doing COM, you will be using the Microsoft supplied IUnknown interface
 * anyway. */
#define __RPC_FAR

/** The IUnknown interface */
#define IUnknownUUID                                                           \
  CFUUIDGetConstantUUIDWithBytes(NULL, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,     \
