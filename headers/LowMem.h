...
*/
   ...
   */
  void
  LMSetCurPageOption(SInt16 value);
   ...
   */
  void
  LMSetScrapName(StringPtr value);
...
/** Carbon Usage: use GetWindowList*/
   ...
   */
  void
  LMSetWindowList(WindowRef value);
   ...
   */
  void
  LMSetOldContent(RgnHandle value);
   ...
   */
  void
  LMSetSaveVisRgn(RgnHandle value);
...
/** Carbon Usage: use GetMenuTrackingData*/
   ...
   */
  void
  LMSetAtMenuBottom(SInt16 value);
  ...
  */
   ...
   */
  void
  LMSetMBarHook(MBarHookUPP value);
   ...
   */
  void
  LMSetMenuHook(MenuHookUPP value);
   ...
   */
  void
  LMSetFScaleDisable(UInt8 value);
   ...
   */
  void
  LMSetTEScrpLength(UInt16 value);
   ...
   */
  void
  LMSetTEScrpHandle(Handle value);
   ...
   */
  void
  LMSetAppParmHandle(Handle value);
   ...
   */
  void
  LMSetResErrProc(ResErrUPP value);
...
/** Carbon Usge: use GetMBarHeight*/
   ...
   */
  void
  LMSetSynListHandle(Handle value);
...
LMSetExtStsDT(UniversalProcPtr ExtStsDTValue, short vectorNumber);
  ...
  */
   ...
   */
  void
  LMSetMouseLocation(Point value);
...
/** accesses "ROMMapHndl"*/
   ...
   */
  void
  LMSetROMMapHandle(Handle value);
...
/** accesses "FmtDefaults"*/
   ...
   */
  Ptr
  LMGetDiskFormatingHFSDefaults(void);
