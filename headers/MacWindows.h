...
#endif
  void
  MacCloseWindow(WindowRef window);
...
/** SetWinColor is not available in Carbon.*/
   ...
   */
  void
  SetWinColor(WindowRef window, WCTabHandle newColorTable);
   ...
   */
  void
  SetDeskCPat(PixPatHandle deskPixPat);
 ...
 * instead.*/
   ...
   */
  void
  DrawNew(WindowRef window, Boolean update);
...
*/
  void
  GetCWMgrPort(CGrafPtr *wMgrCPort);
...
*/
   ...
   */
  void
  HiliteWindow(WindowRef window, Boolean fHilite);
...
*/
  void
  SetWRefCon(WindowRef window, long data);
...
*/
  void
  SetWindowPic(WindowRef window, PicHandle pic);
...
#define MacShowWindow ShowWindow
   ...
   */
  void
  ShowHide(WindowRef window, Boolean showFlag);
