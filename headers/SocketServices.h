/**
    ...
    \brief   This file contains constants and data structures that
...
#if !OPAQUE_UPP_TYPES
enum {
  uppPCCardSSEntryProcInfo = 0x00000FA0
}; /** pascal 2_bytes Func(2_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
inline PCCardSSEntryUPP NewPCCardSSEntryUPP(PCCardSSEntryProcPtr userRoutine) {
  return (PCCardSSEntryUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                                uppPCCardSSEntryProcInfo,
                                                GetCurrentArchitecture());
}
#else
#define NewPCCardSSEntryUPP(userRoutine)                                       \
  (PCCardSSEntryUPP)                                                           \
      NewRoutineDescriptor((ProcPtr)(userRoutine), uppPCCardSSEntryProcInfo,   \
                           GetCurrentArchitecture())
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposePCCardSSEntryUPP(PCCardSSEntryUPP userUPP) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline short InvokePCCardSSEntryUPP(UInt16 fnCode, Ptr callPB, Ptr dataPtr,
                                    PCCardSSEntryUPP userUPP) {
  return (short)CALL_THREE_PARAMETER_UPP(userUPP, uppPCCardSSEntryProcInfo,
                                         fnCode, callPB, dataPtr);
}
#else
...
#if !OPAQUE_UPP_TYPES
enum {
  uppPCCardCSEntryProcInfo = 0x000000C0
}; /** pascal no_return_value Func(4_bytes) */
#ifdef __cplusplus
inline PCCardCSEntryUPP NewPCCardCSEntryUPP(PCCardCSEntryProcPtr userRoutine) {
  return (PCCardCSEntryUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
...
#define NewPCCardCSEntryUPP(userRoutine)                                       \
  (PCCardCSEntryUPP)                                                           \
      NewRoutineDescriptor((ProcPtr)(userRoutine), uppPCCardCSEntryProcInfo,   \
                           GetCurrentArchitecture())
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposePCCardCSEntryUPP(PCCardCSEntryUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void InvokePCCardCSEntryUPP(CSEventEntryPB *pb,
                                   PCCardCSEntryUPP userUPP) {
  CALL_ONE_PARAMETER_UPP(userUPP, uppPCCardCSEntryProcInfo, pb);
}
#else
#define InvokePCCardCSEntryUPP(pb, userUPP)                                    \
  CALL_ONE_PARAMETER_UPP((userUPP), uppPCCardCSEntryProcInfo, (pb))
#endif
#endif
...
#define CallPCCardCSEntryProc(userRoutine, pb)                                 \
  InvokePCCardCSEntryUPP(pb, userRoutine)
#endif /** CALL_NOT_IN_CARBON */
 ...
 */
EXTERN_API(SS_RETCODE)
SSAcknowledgeInterrupt(SSAcknowledgeInterruptPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetSetPriorHandler(SSGetSetPriorHandlerPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetSetSSAddr(SSGetSetSSAddrPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetAccessOffsets(SSGetAccessOffsetsPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetAdapter(SSGetSetAdapterPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetSSInfo(SSGetSSInfoPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetVendorInfo(SSGetVendorInfoPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSInquireAdapter(SSInquireAdapterPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSSetAdapter(SSGetSetAdapterPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetSocket(SSGetSetSocketPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetStatus(SSGetStatusPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSInquireSocket(SSInquireSocketPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSResetSocket(SSResetSocketPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetPage(SSGetSetPagePB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetWindow(SSGetSetWindowPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSInquireWindow(SSInquireWindowPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSSetPage(SSGetSetPagePB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSGetEDC(SSGetSetEDCPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSInquireEDC(SSInquireEDCPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSPauseEDC(SSPauseEDCPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSReadEDC(SSReadEDCPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSResumeEDC(SSResumeEDCPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSSetEDC(SSGetSetEDCPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSStartEDC(SSStartEDCPB *pb, Ptr dataPtr);
 ...
 */
EXTERN_API(SS_RETCODE)
SSStopEDC(SSStopEDCPB *pb, Ptr dataPtr);
