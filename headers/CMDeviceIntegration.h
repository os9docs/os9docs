/**
    ...
    \brief   Color Management Device Interfaces - for MacOSX

    \introduced_in  ColorSync 3.1
...
/**
  ...
  DeviceOnline                    Change to Online as a result of
  CMSetDeviceState DeviceOffline                   Change to Offline as a result
  of CMSetDeviceState DeviceState                     Any change to a device
  state DefaultDevice                   A default device for any device class
  changed DeviceProfiles                  Any change to any device's profiles
