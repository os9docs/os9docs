...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeSCSICallbackUPP(SCSICallbackUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#define SCSIPBHdr                 \
  ...
  struct SCSILoadDriverPB
  {
    ...
    Boolean
        scsiDiskLoadFailed; /* -> if true, indicates call after failure to load */
    SInt8 filler;
  };
  ...
  enum
  {
    ...
    scsiRequestAborted =
        scsiErrorBase + 2, /* -7934 = PB request aborted by the host        */
    scsiUnableToAbort =
        scsiErrorBase + 3, /* -7933 = Unable to Abort PB request          */
    scsiNonZeroStatus =
        scsiErrorBase + 4,            /* -7932 = PB request completed with an err   */
    ...
    scsiUnableToTerminate =
        scsiErrorBase + 9,                            /* -7927 = Unable to Terminate I/O PB req        */
    ...
    scsiMessageRejectReceived =
        scsiErrorBase + 13, /* -7923 = Message reject received           */
    scsiSCSIBusReset =
        scsiErrorBase + 14, /* -7922 = SCSI bus reset sent/received    */
    scsiParityError =
        scsiErrorBase + 15, /* -7921 = Uncorrectable parity error occured     */
    scsiAutosenseFailed =
        scsiErrorBase + 16,            /* -7920 = Autosense: Request sense cmd fail  */
    scsiUnused11 = scsiErrorBase + 17, /* -7919 =                        */
    scsiDataRunError =
        scsiErrorBase + 18,                     /* -7918 = Data overrun/underrun error     */
    scsiUnexpectedBusFree = scsiErrorBase + 19, /* -7917 = Unexpected BUS free */
    scsiSequenceFailed =
        scsiErrorBase + 20, /* -7916 = Target bus phase sequence failure  */
    scsiWrongDirection =
        scsiErrorBase + 21,            /* -7915 = Data phase was in wrong direction  */
    scsiUnused16 = scsiErrorBase + 22, /* -7914 =                        */
    scsiBDRsent =
        scsiErrorBase + 23, /* -7913 = A SCSI BDR msg was sent to target  */
    scsiTerminated =
        scsiErrorBase + 24,           /* -7912 = PB request terminated by the host  */
    scsiNoNexus = scsiErrorBase + 25, /* -7911 = Nexus is not established */
    scsiCDBReceived =
        scsiErrorBase + 26, /* -7910 = The SCSI CDB has been received        */
                            /* Couldn't begin execution  30-3F */
    scsiTooManyBuses =
        scsiErrorBase + 48,        /* -7888 = Register failed because we're full */
    scsiBusy = scsiErrorBase + 49, /* -7887 = SCSI subsystem is busy           */
    scsiProvideFail =
        scsiErrorBase + 50, /* -7886 = Unable to provide requ. capability */
    scsiDeviceNotThere =
        scsiErrorBase + 51,         /* -7885 = SCSI device not installed/there    */
    scsiNoHBA = scsiErrorBase + 52, /* -7884 = No HBA detected Error           */
    scsiDeviceConflict =
        scsiErrorBase + 53,              /* -7883 = sorry, max 1 refNum per DeviceIdent    */
    scsiNoSuchXref = scsiErrorBase + 54, /* -7882 = no such RefNum xref */
    scsiQLinkInvalid =
        scsiErrorBase + 55, /* -7881 = pre-linked PBs not supported      */
                            /*   (The QLink field was nonzero)          */
                            /* Parameter errors  40-7F */
    scsiPBLengthError =
        scsiErrorBase + 64, /* -7872 = (scsiPBLength is insuf'ct/invalid  */
    scsiFunctionNotAvailable =
        scsiErrorBase + 65,                  /* -7871 = The requ. func is not available    */
    ...
    scsiTIDInvalid =
        scsiErrorBase + 68,              /* -7868 = Target ID supplied is invalid      */
    ...
    scsiDataTypeInvalid =
        scsiErrorBase + 71, /* -7865 = scsiDataType requested not supported */
    scsiTransferTypeInvalid =
        scsiErrorBase + 72, /* -7864 = scsiTransferType field is too high     */
    scsiCDBLengthInvalid =
        scsiErrorBase + 73 /* -7863 = scsiCDBLength field is too big        */
  };
  ...
  enum
  {
    ...
    scsiPartialPrepared =
        scsiErrorBase + 77, /* -7859 = could not do full prepare mem for I/O*/
    scsiInvalidMsgType =
        scsiErrorBase + 78,             /* -7858 = Invalid message type (internal)       */
    ...
    scsiIOInProgress =
        scsiErrorBase + 82,                  /* -7854 = Can't close conn, IO in prog      */
    ...
    scsiCannotLoadPlugin =
        scsiErrorBase + 87 /* -7849 = No matching service category      */
  };

  /* +++ */
  /**
   * scsiFamilyInternalError and scsiPluginInternalError are intended to handle
   * consistency check failures. For example, if the family stores a record on a
   * lookaside queue, but does not find that record it can use this error to
   * report this failure. SCSI Manager 4.3 uses dsIOCoreErr in a few places, but
   * this is probably not the best error. In general, internal errors should be
   * reported as bugs.
   *
   ...
   * normally be conveyed to normal applications, but might be used for
   * communication between a plug-in and a vendor-provided device driver (for
   * example, to manage RAID hot-swapping).
   *
   * Note: I don't know how many SCSI errors are reserved in the error code
   * architecture. Don't assume that we'll actually get sixteen, but we should
   * reserve at least one.
   */
  enum
  {
    scsiFamilyInternalError =
        scsiErrorBase + 87, /* -7849 = Internal consistency check failed  */
    scsiPluginInternalError =
        scsiErrorBase + 88, /* -7848 = Internal consistency check failed  */
    scsiVendorSpecificErrorBase =
        scsiErrorBase + 128,          /* ??    = Start of third-party error range     */
  ...
  /* Defines for the bit numbers of the scsiFlags field in the PB header for the
   * SCSIExecIO function */
  enum
  {
  ...
  enum
  {
    ...
    scsiRenegotiateSense =
        0x0100, /* renegotiate sync/wide before issuing autosense     */
    scsiDisableDiscipline =
        0x0200,                      /* disable parameter checking on SCSIExecIO calls */
  ...
  enum
  {
    ...
    scsiBusDataBuffer =
        (1 << scsiDataBuffer),         /* single contiguous buffer supplied      */
    scsiBusDataSG = (1 << scsiDataSG), /* scatter/gather list supplied        */
    scsiBusDataIOTable =
        (1 << scsiDataIOTable),            /* (2/6/95) Prepare Memory for IO*/
  ...
  enum
  {
    scsiBusUltra4SCSI = 0x00000800,           /* HBA supports Ultra4(Ultra320) SCSI */
    ...
    scsiBusInternalExternalUnknown =
        0x00000000, /* not known whether bus is inside or outside     */
    scsiBusInternalExternal =
        0x000000C0,                       /* bus goes inside and outside the box       */
  ...
  enum
  {
    scsiOddDisconnectUnsafeRead1 =
        0x0001, /* Disconnects on odd byte boundries are unsafe with DMA and/or
                   blind reads */
    scsiOddDisconnectUnsafeWrite1 =
        0x0002,                   /* Disconnects on odd byte boundries are unsafe with DMA and/or
                                     blind writes */
    scsiBusErrorsUnsafe = 0x0004, /* Non-handshaked delays or disconnects during
                                     blind transfers may cause a crash */
    scsiRequiresHandshake =
        0x0008,                        /* Non-handshaked delays or disconnects during blind transfers may
                                          cause data corruption */
    scsiTargetDrivenSDTRSafe = 0x0010, /* Targets which initiate synchronous
                                          negotiations are supported */
    scsiOddCountForPhysicalUnsafe =
        0x0020, /* If using physical addrs all counts must be even, and
                   disconnects must be on even boundries */
    scsiAbortCmdFixed =
        0x0040, /* Set if abort command is fixed to properly make callbacks */
    scsiMeshACKTimingFixed =
        0x0080 /* Set if bug allowing Mesh to release ACK prematurely is fixed */
  };
  ...
  struct SIMInitInfo
  {
    ...
    SCSIInterruptUPP
        SIMInterruptPoll;    /* -> pointer to the SIM interrupt poll routine      */
    ...
    SCSIMakeCallbackUPP
        MakeCallback;    /* <- the XPT layer�s SCSIMakeCallback routine            */
  ...
  /**
   * SCSI bus status. These values are returned by the SCSI target in the status
   * phase. They are not related to Macintosh status values (except that values
...
#endif
  OSErr
  SCSIRegisterBus(SIMInitInfo *parameterBlock);
...
#endif
  OSErr
  SCSIDeregisterBus(SCSI_PB *parameterBlock);
...
#endif
  OSErr
  SCSIReregisterBus(SIMInitInfo *parameterBlock);
