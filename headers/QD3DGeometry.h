 ...
 *****************************************************************************/
  ...
  struct TQ3BoxData
  {
    ...
    TQ3AttributeSet *faceAttributeSet; // Ordering : Left, right,                                         //           front, back,                                        //           top, bottom      TQ3AttributeSet boxAttributeSet;
  };
 ...
 *****************************************************************************/
  ...
  enum TQ3PolyhedronEdgeMasks
  {
    ...
    kQ3PolyhedronEdgeAll =
        kQ3PolyhedronEdge01 | kQ3PolyhedronEdge12 | kQ3PolyhedronEdge20
  };
