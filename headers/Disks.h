...
// .Sony 
	/**
		...
		qLink is usually t// .Sony: �diagnostic� raw track dump 
...
// Macros to get a DrvSts pointer or a DrvSts2 pointer from a DrvQEl pointer. 
	...
	<pre>A// CALL_NOT_IN_CARBON 
drvrRefNum driver reference number
drvNum // CALL_NOT_IN_CARBON 
...
QHdrPtr qhp; // address of a QHdr structure 	DrvQEl *qep;
	...
	{
		bp = (Byte *)qep;
		bp -= 4; // point to structure prefix bytes 		</ pre>
					* \copyright THINK Reference © 1991 - 1992 Symantec Corporation
															  *    \non_carbon_cfm in InterfaceLib 7.1 and
			later// address of a QHdr structure 
...
// address of queue header 
		 ...
		 * This i// point to structure prefix bytes 
		 */
		enum
		{
