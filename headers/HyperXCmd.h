...
enum { stackObj = 1, bkgndObj = 2, cardObj = 3, fieldObj = 4, buttonObj = 5 };
 ...
 */
EXTERN_API(void)
SendHCMessage(XCmdPtr paramPtr, ConstStr255Param msg);
 ...
 */
EXTERN_API(void)
RunHandler(XCmdPtr paramPtr, Handle handler);
 ...
 */
EXTERN_API(void)
SetGlobal(XCmdPtr paramPtr, ConstStr255Param globName, Handle globValue);
 ...
 */
EXTERN_API(void)
ZeroBytes(XCmdPtr paramPtr, void *dstPtr, long longCount);
 ...
 */
EXTERN_API(void)
ScanToReturn(XCmdPtr paramPtr, Ptr *scanPtr);
 ...
 */
EXTERN_API(void)
ScanToZero(XCmdPtr paramPtr, Ptr *scanPtr);
 ...
 */
EXTERN_API(long)
StringLength(XCmdPtr paramPtr, void *strPtr);
 ...
 */
EXTERN_API(void)
ZeroTermHandle(XCmdPtr paramPtr, Handle hndl);
 ...
 */
EXTERN_API(void)
BoolToStr(XCmdPtr paramPtr, Boolean value, Str255 str);
 ...
 */
EXTERN_API(void)
Double_tToStr(XCmdPtr paramPtr, double_t num, Str255 str);
 ...
 */
EXTERN_API(void)
LongToStr(XCmdPtr paramPtr, long posNum, Str255 str);
 ...
 */
EXTERN_API(void)
NumToHex(XCmdPtr paramPtr, long num, short nDigits, Str255 str);
 ...
 */
EXTERN_API(void)
NumToStr(XCmdPtr paramPtr, long num, Str255 str);
 ...
 */
EXTERN_API(void)
PointToStr(XCmdPtr paramPtr, Point pt, Str255 str);
 ...
 */
EXTERN_API(void)
RectToStr(XCmdPtr paramPtr, const Rect *rct, Str255 str);
 ...
 */
EXTERN_API(void)
ReturnToPas(XCmdPtr paramPtr, void *zeroStr, Str255 pasStr);
 ...
 */
EXTERN_API(long)
StrToLong(XCmdPtr paramPtr, ConstStr255Param str);
 ...
 */
EXTERN_API(long)
StrToNum(XCmdPtr paramPtr, ConstStr255Param str);
 ...
 */
EXTERN_API(void)
StrToPoint(XCmdPtr paramPtr, ConstStr255Param str, Point *pt);
 ...
 */
EXTERN_API(void)
StrToRect(XCmdPtr paramPtr, ConstStr255Param str, Rect *rct);
 ...
 */
EXTERN_API(void)
ZeroToPas(XCmdPtr paramPtr, void *zeroStr, Str255 pasStr);
 ...
 */
EXTERN_API(void)
SetFieldByID(XCmdPtr paramPtr, Boolean cardFieldFlag, short fieldID,
             Handle fieldVal);
 ...
 */
EXTERN_API(void)
SetFieldByName(XCmdPtr paramPtr, Boolean cardFieldFlag,
 ...
 */
EXTERN_API(void)
SetFieldByNum(XCmdPtr paramPtr, Boolean cardFieldFlag, short fieldNum,
              Handle fieldVal);
 ...
 */
EXTERN_API(void)
SetFieldTE(XCmdPtr paramPtr, Boolean cardFieldFlag, short fieldID,
 ...
 */
EXTERN_API(void)
BeginXSound(XCmdPtr paramPtr, WindowRef window);
 ...
 */
EXTERN_API(void)
GetXResInfo(XCmdPtr paramPtr, short *resFile, short *resID, ResType *rType,
            Str255 name);
 ...
 */
EXTERN_API(void)
SendHCEvent(XCmdPtr paramPtr, const EventRecord *event);
 ...
 */
EXTERN_API(void)
SendWindowMessage(XCmdPtr paramPtr, WindowRef windPtr,
 ...
 */
EXTERN_API(long)
StackNameToNum(XCmdPtr paramPtr, ConstStr255Param stackName);
 ...
 */
EXTERN_API(short)
ShowHCAlert(XCmdPtr paramPtr, short dlgID, ConstStr255Param promptStr);
 ...
 */
EXTERN_API(void)
CloseXWindow(XCmdPtr paramPtr, WindowRef window);
 ...
 */
EXTERN_API(void)
RegisterXWMenu(XCmdPtr paramPtr, WindowRef window, MenuRef menu,
               Boolean registering);
 ...
 */
EXTERN_API(void)
SetXWIdleTime(XCmdPtr paramPtr, WindowRef window, long interval);
 ...
 */
EXTERN_API(void)
XWHasInterruptCode(XCmdPtr paramPtr, WindowRef window, Boolean haveCode);
 ...
 */
EXTERN_API(void)
XWAlwaysMoveHigh(XCmdPtr paramPtr, WindowRef window, Boolean moveHigh);
 ...
 */
EXTERN_API(void)
XWAllowReEntrancy(XCmdPtr paramPtr, WindowRef window, Boolean allowSysEvts,
                  Boolean allowHCEvts);
 ...
 */
EXTERN_API(void)
BeginXWEdit(XCmdPtr paramPtr, WindowRef window);
 ...
 */
EXTERN_API(void)
EndXWEdit(XCmdPtr paramPtr, WindowRef window);
 ...
 */
EXTERN_API(void)
PrintTEHandle(XCmdPtr paramPtr, TEHandle hTE, StringPtr header);
 ...
 */
EXTERN_API(void)
SetCheckPoints(XCmdPtr paramPtr, CheckPtHandle checkLines);
 ...
 */
EXTERN_API(void)
FormatScript(XCmdPtr paramPtr, Handle scriptHndl, long *insertionPoint,
             Boolean quickFormat);
 ...
 */
EXTERN_API(void)
SaveXWScript(XCmdPtr paramPtr, Handle scriptHndl);
 ...
 */
EXTERN_API(void)
GetObjectName(XCmdPtr paramPtr, XTalkObjectPtr xObjPtr, Str255 objName);
 ...
 */
EXTERN_API(void)
GetObjectScript(XCmdPtr paramPtr, XTalkObjectPtr xObjPtr, Handle *scriptHndl);
 ...
 */
EXTERN_API(void)
SetObjectScript(XCmdPtr paramPtr, XTalkObjectPtr xObjPtr, Handle scriptHndl);
 ...
 */
EXTERN_API(void)
StepScript(XCmdPtr paramPtr, Boolean stepInto);
 ...
 */
EXTERN_API(void)
CountHandlers(XCmdPtr paramPtr, short *handlerCount);
 ...
 */
EXTERN_API(void)
GetHandlerInfo(XCmdPtr paramPtr, short handlerNum, Str255 handlerName,
 ...
 */
EXTERN_API(void)
GetVarInfo(XCmdPtr paramPtr, short handlerNum, short varNum, Str255 varName,
 ...
 */
EXTERN_API(void)
SetVarValue(XCmdPtr paramPtr, short handlerNum, short varNum, Handle varHndl);
