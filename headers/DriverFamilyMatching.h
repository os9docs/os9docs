/**
    ...
    \brief   Interfaces for create native drivers NDRV
...
enum {
  kDriverIsLoadedUponDiscovery =
      0x00000001,                       /* auto-load driver when discovered*/
  ...
  kDriverSupportDMSuspendAndResume =
...
enum {
  ...
  kServiceCategoryNdrvDriver =
      FOUR_CHAR_CODE('ndrv'),                       /* Generic Native Driver*/
  ...
  kServiceCategoryGeneric = FOUR_CHAR_CODE(
...
enum {
  ...
  kNdrvTypeIsFWConference =
      FOUR_CHAR_CODE('crsh'), /* FireWire conference camera */
  kNdrvTypeIsAVC =
