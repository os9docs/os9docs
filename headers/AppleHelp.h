/**
    ...
    \introduced_in  Mac OS X/CarbonLib 1.1
...
enum { kAHInternalErr = -10790, kAHInternetConfigPrefErr = -10791 };

typedef SInt16 AHTOCType;
enum { kAHTOCTypeUser = 0, kAHTOCTypeDeveloper = 1 };
...
AHSearch(CFStringRef bookname, CFStringRef query);
 ...
 */
EXTERN_API_C(OSStatus)
AHGotoPage(CFStringRef bookname, CFStringRef path, CFStringRef anchor);
