/**
    ...
    \brief   TCP Manager Interfaces.

    \introduced_in  MacTCP 2.0.6
...
/**
Developer Notes:
        0. This MacTCP header replaces what used to be defined in the following
header files MacTCPCommonTypes.h GetMyIPAddr.h MiscIPPB.h TCPPB.h UDPPB.h

            When the various control calls are made to the ip driver, you must
set up a NewRoutineDescriptor for every non-nil completion routine and/or
notifyProc parameter. Otherwise, the 68K driver code, will not correctly call
your routine.
...
struct ICMPParamBlock {
  ...
  struct {
    unsigned long
        echoRequestOut; /** time in ticks of when the echo request went out */
    unsigned long
        echoReplyIn;     /** time in ticks of when the reply was received */
...
/**   Note: the filler in the following structure is in a different location
 * than */
...
#if !OPAQUE_UPP_TYPES
enum {
  uppGetIPIOCompletionProcInfo = 0x000000C1
}; /** no_return_value Func(4_bytes) */
#ifdef __cplusplus
inline GetIPIOCompletionUPP
NewGetIPIOCompletionUPP(GetIPIOCompletionProcPtr userRoutine) {
  return (GetIPIOCompletionUPP)NewRoutineDescriptor(
      (ProcPtr)(userRoutine), uppGetIPIOCompletionProcInfo,
...
#if !OPAQUE_UPP_TYPES
enum {
  uppIPIOCompletionProcInfo = 0x000000C1
}; /** no_return_value Func(4_bytes) */
#ifdef __cplusplus
inline IPIOCompletionUPP
NewIPIOCompletionUPP(IPIOCompletionProcPtr userRoutine) {
  return (IPIOCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                                 uppIPIOCompletionProcInfo,
                                                 GetCurrentArchitecture());
}
#else
...
#if !OPAQUE_UPP_TYPES
enum {
  uppICMPEchoNotifyProcInfo = 0x000000C1
}; /** no_return_value Func(4_bytes) */
#ifdef __cplusplus
inline ICMPEchoNotifyUPP
NewICMPEchoNotifyUPP(ICMPEchoNotifyProcPtr userRoutine) {
  return (ICMPEchoNotifyUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                                 uppICMPEchoNotifyProcInfo,
                                                 GetCurrentArchitecture());
}
#else
...
#if !OPAQUE_UPP_TYPES
enum {
  uppTCPNotifyProcInfo = 0x0000EEC0
}; /** pascal no_return_value Func(4_bytes, 2_bytes, 4_bytes, 2_bytes, 4_bytes)
    */
#ifdef __cplusplus
inline TCPNotifyUPP NewTCPNotifyUPP(TCPNotifyProcPtr userRoutine) {
  return (TCPNotifyUPP)NewRoutineDescriptor(
...
#if !OPAQUE_UPP_TYPES
enum {
  uppTCPIOCompletionProcInfo = 0x000000C1
}; /** no_return_value Func(4_bytes) */
#ifdef __cplusplus
inline TCPIOCompletionUPP
NewTCPIOCompletionUPP(TCPIOCompletionProcPtr userRoutine) {
  return (TCPIOCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
...
#if !OPAQUE_UPP_TYPES
enum {
  uppUDPNotifyProcInfo = 0x00003EC0
}; /** pascal no_return_value Func(4_bytes, 2_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
inline UDPNotifyUPP NewUDPNotifyUPP(UDPNotifyProcPtr userRoutine) {
  return (UDPNotifyUPP)NewRoutineDescriptor(
...
#if !OPAQUE_UPP_TYPES
enum {
  uppUDPIOCompletionProcInfo = 0x000000C1
}; /** no_return_value Func(4_bytes) */
#ifdef __cplusplus
inline UDPIOCompletionUPP
NewUDPIOCompletionUPP(UDPIOCompletionProcPtr userRoutine) {
  return (UDPIOCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
                                                  uppUDPIOCompletionProcInfo,
                                                  GetCurrentArchitecture());
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeGetIPIOCompletionUPP(GetIPIOCompletionUPP userUPP) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeIPIOCompletionUPP(IPIOCompletionUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeICMPEchoNotifyUPP(ICMPEchoNotifyUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeTCPNotifyUPP(TCPNotifyUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeTCPIOCompletionUPP(TCPIOCompletionUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeUDPNotifyUPP(UDPNotifyUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeUDPIOCompletionUPP(UDPIOCompletionUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void InvokeGetIPIOCompletionUPP(GetAddrParamBlock *iopb,
                                       GetIPIOCompletionUPP userUPP) {
  CALL_ONE_PARAMETER_UPP(userUPP, uppGetIPIOCompletionProcInfo, iopb);
}
#else
#define InvokeGetIPIOCompletionUPP(iopb, userUPP)                              \
  CALL_ONE_PARAMETER_UPP((userUPP), uppGetIPIOCompletionProcInfo, (iopb))
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void InvokeIPIOCompletionUPP(ICMPParamBlock *iopb,
                                    IPIOCompletionUPP userUPP) {
  CALL_ONE_PARAMETER_UPP(userUPP, uppIPIOCompletionProcInfo, iopb);
}
#else
#define InvokeIPIOCompletionUPP(iopb, userUPP)                                 \
  CALL_ONE_PARAMETER_UPP((userUPP), uppIPIOCompletionProcInfo, (iopb))
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void InvokeICMPEchoNotifyUPP(ICMPParamBlock *iopb,
                                    ICMPEchoNotifyUPP userUPP) {
  CALL_ONE_PARAMETER_UPP(userUPP, uppICMPEchoNotifyProcInfo, iopb);
}
#else
#define InvokeICMPEchoNotifyUPP(iopb, userUPP)                                 \
  CALL_ONE_PARAMETER_UPP((userUPP), uppICMPEchoNotifyProcInfo, (iopb))
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void InvokeTCPNotifyUPP(StreamPtr tcpStream, unsigned short eventCode,
                               Ptr userDataPtr, unsigned short terminReason,
                               ICMPReport *icmpMsg, TCPNotifyUPP userUPP) {
  CALL_FIVE_PARAMETER_UPP(userUPP, uppTCPNotifyProcInfo, tcpStream, eventCode,
                          userDataPtr, terminReason, icmpMsg);
}
#else
#define InvokeTCPNotifyUPP(tcpStream, eventCode, userDataPtr, terminReason,    \
                           icmpMsg, userUPP)                                   \
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void InvokeTCPIOCompletionUPP(TCPiopb *iopb,
                                     TCPIOCompletionUPP userUPP) {
  CALL_ONE_PARAMETER_UPP(userUPP, uppTCPIOCompletionProcInfo, iopb);
}
#else
#define InvokeTCPIOCompletionUPP(iopb, userUPP)                                \
  CALL_ONE_PARAMETER_UPP((userUPP), uppTCPIOCompletionProcInfo, (iopb))
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void InvokeUDPNotifyUPP(StreamPtr udpStream, unsigned short eventCode,
                               Ptr userDataPtr, ICMPReport *icmpMsg,
                               UDPNotifyUPP userUPP) {
  CALL_FOUR_PARAMETER_UPP(userUPP, uppUDPNotifyProcInfo, udpStream, eventCode,
                          userDataPtr, icmpMsg);
}
#else
#define InvokeUDPNotifyUPP(udpStream, eventCode, userDataPtr, icmpMsg,         \
                           userUPP)                                            \
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void InvokeUDPIOCompletionUPP(UDPiopb *iopb,
                                     UDPIOCompletionUPP userUPP) {
  CALL_ONE_PARAMETER_UPP(userUPP, uppUDPIOCompletionProcInfo, iopb);
}
#else
#define InvokeUDPIOCompletionUPP(iopb, userUPP)                                \
  CALL_ONE_PARAMETER_UPP((userUPP), uppUDPIOCompletionProcInfo, (iopb))
#endif
#endif
...
#define NewGetIPIOCompletionProc(userRoutine)                                  \
  NewGetIPIOCompletionUPP(userRoutine)
...
#define CallGetIPIOCompletionProc(userRoutine, iopb)                           \
  InvokeGetIPIOCompletionUPP(iopb, userRoutine)
#define CallIPIOCompletionProc(userRoutine, iopb)                              \
  InvokeIPIOCompletionUPP(iopb, userRoutine)
#define CallICMPEchoNotifyProc(userRoutine, iopb)                              \
  InvokeICMPEchoNotifyUPP(iopb, userRoutine)
...
#define CallTCPIOCompletionProc(userRoutine, iopb)                             \
  InvokeTCPIOCompletionUPP(iopb, userRoutine)
#define CallUDPNotifyProc(userRoutine, udpStream, eventCode, userDataPtr,      \
                          icmpMsg)                                             \
  InvokeUDPNotifyUPP(udpStream, eventCode, userDataPtr, icmpMsg, userRoutine)
#define CallUDPIOCompletionProc(userRoutine, iopb)                             \
  InvokeUDPIOCompletionUPP(iopb, userRoutine)
#endif /** CALL_NOT_IN_CARBON */
