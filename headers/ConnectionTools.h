/**
    ...
    \brief   Communications Toolbox Connection Tools Interfaces.
...
enum {
  ...
  csetType =
      FOUR_CHAR_CODE('cset'), /** connection setup definition procedure */
  clocType = FOUR_CHAR_CODE(
      'cloc'), /** connection configuration localization defProc */
  cscrType =
      FOUR_CHAR_CODE('cscr'), /** connection scripting defProc interfaces */
