...
#pragma pack(2)
   ...
   */
   ...
   {
      /** that */
      use the Roman character mapping englishHighWord = (long)0x80000000 dutchHighWord = 0x40000000, /** Afrikaans */
      germanHighWord = 0x20000000 swedishHighWord = 0x10000000                                       // also Afrikaans
      spanishHighWord = 0x04000000,                                                                  /** Catalan */
      portugueseHighWord = 0x02000000 italianHighWord = 0x01000000,                                  // also Norwegian
      frenchHighWord = 0x00800000,
      romanHighWord = 0x00400000, // also Catalan
      0x00040000,                 /** European */
      languages not using Cyrillic croatianHighWord = 0x00020000 turkishHighWord = 0x00010000,
      ...
      */
      enum {
          /** phases */
          kFBCphIndexing = 0 kFBCphFlushing = 1, // sum of first 9
          kFBCphMerging = 2,
          kFBCphMakingIndexAccessor = 3,
          kFBCphCompacting = 4,
          kFBCphIndexWaiting = 5, /** phases */
          kFBCphSearching = 6 kFBCphMakingAccessAccessor = 7,
          kFBCphAccessWaiting = 8,
          kFBCphSummarizing = 9 /** or */
          access kFBCphIdle = 10 kFBCphCanceling = 11};
...
#if !OPAQUE_UPP_TYPES
      enum {
          uppFBCCallbackProcInfo = 0x00000F91}; // 1_byte Func(2_bytes, 4_bytes, 4_bytes) #ifdef __cplusplus
...
#define InvokeFBCCallbackUPP(phase, percentDone, data, userUPP) \
   ...
   */
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCSetSessionVolumes(FBCSearchSession theSession, const SInt16 vRefNums[],
                              UInt16 numVolumes);
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCGetSessionVolumes(FBCSearchSession theSession, SInt16 vRefNums[],
                              UInt16 *numVolumes);
   ...
   */
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCDoQuerySearch(FBCSearchSession theSession, char *queryText,
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCDoCFStringSearch(FBCSearchSession theSession, CFStringRef queryString,
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCDoExampleSearch(FBCSearchSession theSession, const UInt32 *exampleHitNums,
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCBlindExampleSearch(FSSpec examples[], UInt32 numExamples,
                               const FSSpec targetDirs[], UInt32 numTargets,
   ...
   */
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCGetHitDocument(FBCSearchSession theSession, UInt32 hitNumber,
                           FSSpec *theDocument);
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCGetHitDocumentRef(FBCSearchSession theSession, UInt32 hitNumber,
                              FSRef *theDocument);
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCGetMatchedWords(FBCSearchSession theSession, UInt32 hitNumber,
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCGetTopicWords(FBCSearchSession theSession, UInt32 hitNumber,
                          UInt32 *wordCount, FBCWordList *list);
   ...
   */
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCSummarize(void *inBuf, UInt32 inLength, void *outBuf, UInt32 *outLength,
                      UInt32 *numSentences);
   ...
   */
    ...
    *    \mac_os_x         in version 10.0 and later
    */
   OSErr FBCIndexItemsInLanguages(FSSpecArrayPtr theItems, UInt32 itemCount,
