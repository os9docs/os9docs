...
/**
   ...
   the specified sound bank as the sample data source.

    This field requires QuickTime 5.0 or later and should be set to NULL for
   prior versions.
*/
struct SynthesizerConnections {
  OSType clientID;
  OSType inputPortID;  /* terminology death: this port is used to SEND to the
                          midi synth */
  OSType outputPortID; /* terminology death: this port receives from a keyboard
                          or other control device */
  long midiChannel; /* The system channel; others are configurable (or the nubus
                       slot number) */
  long flags;
...
QTMIDIGetMIDIPorts(QTMIDIComponent ci, QTMIDIPortListHandle *inputPorts,
 ...
 */
EXTERN_API(ComponentResult)
QTMIDIUseSendPort(QTMIDIComponent ci, long portIndex, long inUse)
 ...
 */
EXTERN_API(ComponentResult)
QTMIDISendMIDI(QTMIDIComponent ci, long portIndex, MusicMIDIPacket *mp)
...
enum {
  ...
  cantSendToSynthesizerErr =
      (0x80000000 | (0xFFFF & (cantSendToSynthesizerOSErr))),
  cantReceiveFromSynthesizerErr =
      (0x80000000 | (0xFFFF & (cantReceiveFromSynthesizerOSErr))),
  illegalVoiceAllocationErr =
      (0x80000000 | (0xFFFF & (illegalVoiceAllocationOSErr))),
...
enum {
  ...
  kGenericMusicCallROMInstrument =
      1 << 8, /* call MusicSetInstrument for MusicSetPartInstrumentNumber for
                 "ROM" instruments, passing params from the ROMi resource */
  kGenericMusicAllDefaults =
      1 << 9 /* indicates that when a new instrument is recalled, all knobs are
                reset to DEFAULT settings. True for GS modules */
};
 ...
 */
EXTERN_API(ComponentResult)
MusicGetPartInstrumentNumber(MusicComponent mc, long part)
 ...
 */
EXTERN_API(ComponentResult)
MusicSetPartAtomicInstrument(MusicComponent mc, long part,
                             AtomicInstrumentPtr aiP, long flags)
 ...
 */
EXTERN_API(ComponentResult)
MusicSetPartKnob(MusicComponent mc, long part, long knobID, long knobValue)
 ...
 */
EXTERN_API(ComponentResult)
MusicGetKnob(MusicComponent mc, long knobID)
 ...
 */
EXTERN_API(ComponentResult)
MusicSetKnob(MusicComponent mc, long knobID, long knobValue)
 ...
 */
EXTERN_API(ComponentResult)
MusicGetPartName(MusicComponent mc, long part, StringPtr name)
 ...
 */
EXTERN_API(ComponentResult)
MusicSetPartName(MusicComponent mc, long part, StringPtr name)
 ...
 */
EXTERN_API(ComponentResult)
MusicFindTone(MusicComponent mc, ToneDescription *td, long *libraryIndexOut,
              unsigned long *fit)
 ...
 */
EXTERN_API(ComponentResult)
MusicSetPartController(MusicComponent mc, long part,
                       MusicController controllerNumber, long controllerValue)
    FIVEWORDINLINE(0x2F3C, 0x000C, 0x0019, 0x7000, 0xA82A);

#if OLDROUTINENAMES
#define MusicSetController(ci, part, controllerNumber, controllerValue)        \
  MusicSetPartController(ci, part, controllerNumber, controllerValue)
#endif
 ...
 */
EXTERN_API(ComponentResult)
MusicGetPartController(MusicComponent mc, long part,
 ...
 */
EXTERN_API(ComponentResult)
MusicGetMIDIProc(MusicComponent mc, MusicMIDISendUPP *midiSendProc,
                 long *refCon)
 ...
 */
EXTERN_API(ComponentResult)
MusicGetDrumNames(MusicComponent mc, long modifiableInstruments,
                  Handle *instrumentNumbers, Handle *instrumentNames)
 ...
 */
EXTERN_API(ComponentResult)
MusicGetInstrumentAboutInfo(MusicComponent mc, long part,
 ...
 */
EXTERN_API(ComponentResult)
MusicGetKnobSettingStrings(MusicComponent mc, long knobIndex, long isGlobal,
                           Handle *settingsNames, Handle *settingsCategoryLasts,
 ...
 */
EXTERN_API(ComponentResult)
MusicGetMIDIPorts(MusicComponent mc, long *inputPortCount,
 ...
 */
EXTERN_API(ComponentResult)
MusicSendMIDI(MusicComponent mc, long portIndex, MusicMIDIPacket *mp)
...
MusicStartOffline(MusicComponent mc, unsigned long *numChannels,
                  ...
                  MusicOfflineDataUPP dataProc, long dataProcRefCon)
 ...
 */
EXTERN_API(ComponentResult)
MusicSetOfflineTimeTo(MusicComponent mc, long newTimeStamp)
 ...
 */
EXTERN_API(ComponentResult)
MusicGetInstrumentKnobDescription(MusicComponent mc, long knobIndex,
                                  KnobDescription *mkd)
 ...
 */
EXTERN_API(ComponentResult)
MusicGetDrumKnobDescription(MusicComponent mc, long knobIndex,
                            KnobDescription *mkd)
 ...
 */
EXTERN_API(ComponentResult)
MusicGetKnobDescription(MusicComponent mc, long knobIndex, KnobDescription *mkd)
 ...
 */
EXTERN_API(ComponentResult)
MusicGetInstrumentInfo(MusicComponent mc, long getInstrumentInfoFlags,
 ...
 */
EXTERN_API(ComponentResult)
MusicSetPartInstrumentNumberInterruptSafe(MusicComponent mc, long part,
                                          long instrumentNumber)
 ...
 */
EXTERN_API(ComponentResult)
MusicSetPartSoundLocalization(MusicComponent mc, long part, Handle data)
 ...
 */
EXTERN_API(ComponentResult)
MusicGenericConfigure(MusicComponent mc, long mode, long flags, long baseResID)
 ...
 */
EXTERN_API(ComponentResult)
MusicGenericGetPart(MusicComponent mc, long partNumber, GCPart **part)
 ...
 */
EXTERN_API(ComponentResult)
MusicGenericGetKnobList(MusicComponent mc, long knobType,
 ...
 */
EXTERN_API(ComponentResult)
MusicGenericSetResourceNumbers(MusicComponent mc, Handle resourceIDH)
 ...
 */
EXTERN_API(ComponentResult)
MusicDerivedSetKnob(MusicComponent mc, long knobType, long knobNumber,
                    long knobValue, long partNumber, GCPart *p,
 ...
 */
EXTERN_API(ComponentResult)
MusicDerivedSetPart(MusicComponent mc, long partNumber, GCPart *p)
 ...
 */
EXTERN_API(ComponentResult)
MusicDerivedSetInstrument(MusicComponent mc, long partNumber, GCPart *p)
 ...
 */
EXTERN_API(ComponentResult)
MusicDerivedSetPartInstrumentNumber(MusicComponent mc, long partNumber,
                                    GCPart *p)
 ...
 */
EXTERN_API(ComponentResult)
MusicDerivedSetMIDI(MusicComponent mc, MusicMIDISendUPP midiProc, long refcon,
                    long midiChannel)
 ...
 */
EXTERN_API(ComponentResult)
MusicDerivedStorePartInstrument(MusicComponent mc, long partNumber, GCPart *p,
                                long instrumentNumber)
...
MusicDerivedOpenResFile(MusicComponent mc)
    FIVEWORDINLINE(0x2F3C, 0x0000, 0x0207, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
MusicDerivedCloseResFile(MusicComponent mc, short resRefNum)
...
/**
    The midiChannelAssignment field of this structure is used to assign a MIDI
   channel when a NoteChannel is created from a NoteRequest. A value of 0
   indicates a MIDI channel has *not* been assigned A value of
   (kNoteRequestSpecifyMIDIChannel | 1->16) is a MIDI channel assignment

    This field requires QuickTime 5.0 or later and should be set to 0 for prior
   versions.
*/
 ...
 */
EXTERN_API(ComponentResult)
NARegisterMusicDevice(NoteAllocator na, OSType synthType, Str31 name,
 ...
 */
EXTERN_API(ComponentResult)
NAUnregisterMusicDevice(NoteAllocator na, long index)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0001, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
NAGetRegisteredMusicDevice(NoteAllocator na, long index, OSType *synthType,
                           Str31 name, SynthesizerConnections *connections,
                           MusicComponent *mc)
 ...
 */
EXTERN_API(ComponentResult)
NANewNoteChannel(NoteAllocator na, NoteRequest *noteRequest,
 ...
 */
EXTERN_API(ComponentResult)
NADisposeNoteChannel(NoteAllocator na, NoteChannel noteChannel)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0005, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
NAPrerollNoteChannel(NoteAllocator na, NoteChannel noteChannel)
 ...
 */
EXTERN_API(ComponentResult)
NAResetNoteChannel(NoteAllocator na, NoteChannel noteChannel)
 ...
 */
EXTERN_API(ComponentResult)
NAPlayNote(NoteAllocator na, NoteChannel noteChannel, long pitch, long velocity)
 ...
 */
EXTERN_API(ComponentResult)
NASetController(NoteAllocator na, NoteChannel noteChannel,
 ...
 */
EXTERN_API(ComponentResult)
NASetKnob(NoteAllocator na, NoteChannel noteChannel, long knobNumber,
          long knobValue)
 ...
 */
EXTERN_API(ComponentResult)
NAFindNoteChannelTone(NoteAllocator na, NoteChannel noteChannel,
                      ToneDescription *td, long *instrumentNumber)
 ...
 */
EXTERN_API(ComponentResult)
NASetInstrumentNumber(NoteAllocator na, NoteChannel noteChannel,
                      long instrumentNumber)
    FIVEWORDINLINE(0x2F3C, 0x0008, 0x0011, 0x7000, 0xA82A);

#if OLDROUTINENAMES
#define NASetNoteChannelInstrument(ci, noteChannel, instrumentNumber)          \
  NASetInstrumentNumber(ci, noteChannel, instrumentNumber)
#define NASetInstrument(ci, noteChannel, instrumentNumber)                     \
  NASetInstrumentNumber(ci, noteChannel, instrumentNumber)
#endif
/**
 *  NAPickInstrument()
 ...
 */
EXTERN_API(ComponentResult)
NAPickInstrument(NoteAllocator na, ModalFilterUPP filterProc, StringPtr prompt,
                 ToneDescription *sd, unsigned long flags, long refCon,
 ...
 */
EXTERN_API(ComponentResult)
NAPickArrangement(NoteAllocator na, ModalFilterUPP filterProc, StringPtr prompt,
                  long zero1, long zero2, Track t, StringPtr songName)
 ...
 */
EXTERN_API(ComponentResult)
NAStuffToneDescription(NoteAllocator na, long gmNumber, ToneDescription *td)
    FIVEWORDINLINE(0x2F3C, 0x0008, 0x001B, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
NACopyrightDialog(NoteAllocator na, PicHandle p, StringPtr author,
                  StringPtr copyright, StringPtr other, StringPtr title,
                  ModalFilterUPP filterProc, long refCon)
 ...
 */
EXTERN_API(ComponentResult)
NAGetIndNoteChannel(NoteAllocator na, long index, NoteChannel *nc, long *seed)
 ...
 */
EXTERN_API(ComponentResult)
NAGetMIDIPorts(NoteAllocator na, QTMIDIPortListHandle *inputPorts,
               QTMIDIPortListHandle *outputPorts)
 ...
 */
EXTERN_API(ComponentResult)
NAGetNoteRequest(NoteAllocator na, NoteChannel noteChannel, NoteRequest *nrOut)
    FIVEWORDINLINE(0x2F3C, 0x0008, 0x0022, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
NASendMIDI(NoteAllocator na, NoteChannel noteChannel, MusicMIDIPacket *mp)
 ...
 */
EXTERN_API(ComponentResult)
NAPickEditInstrument(NoteAllocator na, ModalFilterUPP filterProc,
                     StringPtr prompt, long refCon, NoteChannel nc,
...
NANewNoteChannelFromAtomicInstrument(NoteAllocator na,
                                     AtomicInstrumentPtr instrument, long flags,
                                     NoteChannel *outChannel)
 ...
 */
EXTERN_API(ComponentResult)
NASetAtomicInstrument(NoteAllocator na, NoteChannel noteChannel,
                      AtomicInstrumentPtr instrument, long flags)
 ...
 */
EXTERN_API(ComponentResult)
NAGetKnob(NoteAllocator na, NoteChannel noteChannel, long knobNumber,
          long *knobValue)
 ...
 */
EXTERN_API(ComponentResult)
NASetNoteChannelBalance(NoteAllocator na, NoteChannel noteChannel, long balance)
 ...
 */
EXTERN_API(ComponentResult)
NASetInstrumentNumberInterruptSafe(NoteAllocator na, NoteChannel noteChannel,
                                   long instrumentNumber)
    FIVEWORDINLINE(0x2F3C, 0x0008, 0x002B, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
NASetNoteChannelSoundLocalization(NoteAllocator na, NoteChannel noteChannel,
                                  Handle data)
    FIVEWORDINLINE(0x2F3C, 0x0008, 0x002C, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
NAGetController(NoteAllocator na, NoteChannel noteChannel,
                long controllerNumber, long *controllerValue)
    FIVEWORDINLINE(0x2F3C, 0x000C, 0x002D, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
TuneSetHeader(TunePlayer tp, unsigned long *header)
 ...
 */
EXTERN_API(ComponentResult)
TuneGetTimeBase(TunePlayer tp, TimeBase *tb)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0005, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
TuneSetTimeScale(TunePlayer tp, TimeScale scale)
 ...
 */
EXTERN_API(ComponentResult)
TuneGetTimeScale(TunePlayer tp, TimeScale *scale)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0007, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
TuneQueue(TunePlayer tp, unsigned long *tune, Fixed tuneRate,
          unsigned long tuneStartPosition, unsigned long tuneStopPosition,
 ...
 */
EXTERN_API(ComponentResult)
TuneInstant(TunePlayer tp, unsigned long *tune, unsigned long tunePosition)
    FIVEWORDINLINE(0x2F3C, 0x0008, 0x000B, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
TuneSetVolume(TunePlayer tp, Fixed volume)
 ...
 */
EXTERN_API(ComponentResult)
TuneSetNoteChannels(TunePlayer tp, unsigned long count,
                    NoteChannel *noteChannelList,
                    TunePlayCallBackUPP playCallBackProc, long refCon)
 ...
 */
EXTERN_API(ComponentResult)
TuneSetPartTranspose(TunePlayer tp, unsigned long part, long transpose,
                     long velocityShift)
 ...
 */
EXTERN_API(ComponentResult)
TuneSetSofter(TunePlayer tp, long softer)
    FIVEWORDINLINE(0x2F3C, 0x0004, 0x0018, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
TuneSetBalance(TunePlayer tp, long balance)
 ...
 */
EXTERN_API(ComponentResult)
TuneSetPartMix(TunePlayer tp, unsigned long partNumber, long volume,
               long balance, long mixFlags)
    FIVEWORDINLINE(0x2F3C, 0x0010, 0x001D, 0x7000, 0xA82A);
 ...
 */
EXTERN_API(ComponentResult)
TuneGetPartMix(TunePlayer tp, unsigned long partNumber, long *volumeOut,
               long *balanceOut, long *mixFlagsOut)
    FIVEWORDINLINE(0x2F3C, 0x0010, 0x001E, 0x7000, 0xA82A);

typedef unsigned long MusicOpWord;
typedef MusicOpWord *MusicOpWordPtr;
/*    QuickTime Music Track Event Formats:

    At this time, QuickTime music tracks support 5 different event types -- REST
   ...
   (7-bit Volume) (1 0) (8-bit UNUSED) (22-bit Duration)
        ...
        ©©Variable GENERAL Length Events (N bytes/event):
            ...
            where:  Length field is the number of LONG words in the record.
                    Lengths include the first and last long words (Minimum
   length = 2)
    ...
    For all events, the following generalizations apply:
        ...
        -   Controllers from 0 to 127 correspond to the standard MIDI
   controllers. Controllers greater than 127 correspond to other controls (i.e.,
...
enum { kEndMarkerValue = 0x00000060 };
...
#define qtma_RestDuration(x)                                                   \
  (qtma_EXT(x, kRestEventDurationFieldPos, kRestEventDurationFieldWidth))
#define qtma_Part(x) (qtma_EXT(x, kEventPartFieldPos, kEventPartFieldWidth))
#define qtma_XPart(m, l)                                                       \
  (qtma_EXT(m, kXEventPartFieldPos, kXEventPartFieldWidth))
...
#define qtma_NoteVolume(x)                                                     \
  (qtma_EXT(x, kNoteEventVolumeFieldPos, kNoteEventVolumeFieldWidth) +         \
   kNoteEventVolumeOffset)
#define qtma_NoteDuration(x)                                                   \
  (qtma_EXT(x, kNoteEventDurationFieldPos, kNoteEventDurationFieldWidth))
#define qtma_NoteVelocity qtma_NoteVolume
#define qtma_XNotePitch(m, l)                                                  \
  (qtma_EXT(m, kXNoteEventPitchFieldPos, kXNoteEventPitchFieldWidth))
#define qtma_XNoteVolume(m, l)                                                 \
  (qtma_EXT(l, kXNoteEventVolumeFieldPos, kXNoteEventVolumeFieldWidth))
#define qtma_XNoteDuration(m, l)                                               \
  (qtma_EXT(l, kXNoteEventDurationFieldPos, kXNoteEventDurationFieldWidth))
...
#define qtma_ControlValue(x)                                                   \
  (qtma_EXT(x, kControlEventValueFieldPos, kControlEventValueFieldWidth))
#define qtma_XControlController(m, l)                                          \
  (qtma_EXT(l, kXControlEventControllerFieldPos,                               \
            kXControlEventControllerFieldWidth))
#define qtma_XControlValue(m, l)                                               \
  (qtma_EXT(m, kXControlEventValueFieldPos, kXControlEventValueFieldWidth))
#define qtma_MarkerSubtype(x)                                                  \
  (qtma_EXT(x, kMarkerEventSubtypeFieldPos, kMarkerEventSubtypeFieldWidth))
#define qtma_MarkerValue(x)                                                    \
  (qtma_EXT(x, kMarkerEventValueFieldPos, kMarkerEventValueFieldWidth))
...
#define qtma_KnobKnob(m, l)                                                    \
  (qtma_EXT(l, kKnobEventKnobFieldPos, kKnobEventKnobFieldWidth))
#define qtma_GeneralSubtype(m, l)                                              \
  (qtma_EXT(l, kGeneralEventSubtypeFieldPos, kGeneralEventSubtypeFieldWidth))
#define qtma_GeneralLength(m, l)                                               \
  (qtma_EXT(m, kGeneralEventLengthFieldPos, kGeneralEventLengthFieldWidth))
...
NewMusicOfflineDataUPP(MusicOfflineDataProcPtr userRoutine) {
  return (MusicOfflineDataUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
...
NewTunePlayCallBackUPP(TunePlayCallBackProcPtr userRoutine) {
  return (TunePlayCallBackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine),
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeMusicMIDISendUPP(MusicMIDISendUPP userUPP) {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeMusicOfflineDataUPP(MusicOfflineDataUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeTuneCallBackUPP(TuneCallBackUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void DisposeTunePlayCallBackUPP(TunePlayCallBackUPP userUPP) {
  DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline ComponentResult InvokeMusicMIDISendUPP(ComponentInstance self,
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline ComponentResult InvokeMusicOfflineDataUPP(Ptr SoundData, long numBytes,
                                                 long myRefCon,
                                                 MusicOfflineDataUPP userUPP) {
  return (ComponentResult)CALL_THREE_PARAMETER_UPP(
      userUPP, uppMusicOfflineDataProcInfo, SoundData, numBytes, myRefCon);
}
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
inline void InvokeTunePlayCallBackUPP(unsigned long *event, long seed,
                                      long refCon,
                                      TunePlayCallBackUPP userUPP) {
...
#define CallMusicMIDISendProc(userRoutine, self, refCon, mmp)                  \
  InvokeMusicMIDISendUPP(self, refCon, mmp, userRoutine)
#define CallMusicOfflineDataProc(userRoutine, SoundData, numBytes, myRefCon)   \
  InvokeMusicOfflineDataUPP(SoundData, numBytes, myRefCon, userRoutine)
