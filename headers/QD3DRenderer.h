/**
    ...
    \brief   Q3Renderer types and routines
...
typedef CALLBACK_API_C(TQ3Boolean,
                       TQ3MacOSDialogEventHandler)(const EventRecord *event);
...
typedef CALLBACK_API_C(void,
                       TQ3RaveDestroyCallback)(TQ3RendererObject renderer);
#if CALL_NOT_IN_CARBON
/**
...
enum {
  ...
  kQ3XAttributeMaskAll = (long)0x800007FF,
  kQ3XAttributeMaskInherited = 0x03FF,
  kQ3XAttributeMaskInterpolated =
      kQ3XAttributeMaskSurfaceUV | kQ3XAttributeMaskShadingUV |
      kQ3XAttributeMaskNormal | kQ3XAttributeMaskAmbientCoefficient |
      kQ3XAttributeMaskDiffuseColor | kQ3XAttributeMaskSpecularColor |
      kQ3XAttributeMaskSpecularControl | kQ3XAttributeMaskTransparencyColor |
...
typedef CALLBACK_API_C(TQ3Status, TQ3XRendererModalConfigureMethod)(
    TQ3RendererObject renderer, TQ3DialogAnchor dialogAnchor,
    TQ3Boolean *canceled, void *rendererPrivate);
/**
 ...
 *  OPTIONAL
 */
enum { kQ3XMethodTypeRendererGetNickNameString = FOUR_CHAR_CODE('rdns') };

typedef CALLBACK_API_C(TQ3Status, TQ3XRendererGetNickNameStringMethod)(
    unsigned char *dataBuffer, unsigned long bufferSize,
    unsigned long *actualDataSize);
/**
 ...
 *  OPTIONAL
 */
enum { kQ3XMethodTypeRendererGetConfigurationData = FOUR_CHAR_CODE('rdgp') };

typedef CALLBACK_API_C(TQ3Status, TQ3XRendererGetConfigurationDataMethod)(
    TQ3RendererObject renderer, unsigned char *dataBuffer,
    unsigned long bufferSize, unsigned long *actualDataSize,
    void *rendererPrivate);
/**
 ...
 *  OPTIONAL
 */
enum { kQ3XMethodTypeRendererSetConfigurationData = FOUR_CHAR_CODE('rdsp') };

typedef CALLBACK_API_C(TQ3Status, TQ3XRendererSetConfigurationDataMethod)(
    TQ3RendererObject renderer, unsigned char *dataBuffer,
    unsigned long bufferSize, void *rendererPrivate);
/*******************************************************************************
 **                                                                          **
 ...
 *  REQUIRED
 */
enum { kQ3XMethodTypeRendererStartPass = FOUR_CHAR_CODE('rdst') };

typedef CALLBACK_API_C(TQ3Status,
                       TQ3XRendererStartPassMethod)(TQ3ViewObject view,
                                                    void *rendererPrivate,
 ...
 *  OPTIONAL
 */
enum { kQ3XMethodTypeRendererFlushFrame = FOUR_CHAR_CODE('rdfl') };
 ...
 *  REQUIRED
 */
enum { kQ3XMethodTypeRendererEndPass = FOUR_CHAR_CODE('rded') };

typedef CALLBACK_API_C(TQ3ViewStatus,
                       TQ3XRendererEndPassMethod)(TQ3ViewObject view,
                                                  void *rendererPrivate);
/**
 ...
 *  OPTIONAL
 */
enum { kQ3XMethodTypeRendererEndFrame = FOUR_CHAR_CODE('rdsy') };
 ...
 *  REQUIRED
 */
enum { kQ3XMethodTypeRendererCancel = FOUR_CHAR_CODE('rdab') };

typedef CALLBACK_API_C(void, TQ3XRendererCancelMethod)(TQ3ViewObject view,
                                                       void *rendererPrivate);
/*******************************************************************************
 **                                                                          **
 ...
 *
 */
enum { kQ3XMethodTypeRendererPush = FOUR_CHAR_CODE('rdps') };

typedef CALLBACK_API_C(TQ3Status,
                       TQ3XRendererPushMethod)(TQ3ViewObject view,
                                               void *rendererPrivate);
enum { kQ3XMethodTypeRendererPop = FOUR_CHAR_CODE('rdpo') };

typedef CALLBACK_API_C(TQ3Status, TQ3XRendererPopMethod)(TQ3ViewObject view,
                                                         void *rendererPrivate);
/*******************************************************************************
 **                                                                          **
 ...
 *
 */
enum { kQ3XMethodTypeRendererIsBoundingBoxVisible = FOUR_CHAR_CODE('rdbx') };

typedef CALLBACK_API_C(TQ3Boolean, TQ3XRendererIsBoundingBoxVisibleMethod)(
    TQ3ViewObject view, void *rendererPrivate, const TQ3BoundingBox *bBox);
...
typedef CALLBACK_API_C(TQ3Status, TQ3XRendererSubmitGeometryMethod)(
    TQ3ViewObject view, void *rendererPrivate, TQ3GeometryObject geometry,
 ...
 *  OPTIONAL
 */
enum { kQ3XMethodTypeRendererSubmitCameraMetaHandler = FOUR_CHAR_CODE('rdcm') };
 ...
 */
typedef CALLBACK_API_C(TQ3Status,
                       TQ3XRendererSubmitCameraMethod)(TQ3ViewObject view,
                                                       void *rendererPrivate,
                                                       TQ3CameraObject camera,
                                                       const void *publicData);
/**
 ...
 *  OPTIONAL
 */
enum { kQ3XMethodTypeRendererSubmitLightMetaHandler = FOUR_CHAR_CODE('rdlg') };
 ...
 */
typedef CALLBACK_API_C(TQ3Status,
                       TQ3XRendererSubmitLightMethod)(TQ3ViewObject view,
                                                      void *rendererPrivate,
 ...
 *  Style
 */
enum { kQ3XMethodTypeRendererUpdateStyleMetaHandler = FOUR_CHAR_CODE('rdyu') };
 ...
 */
typedef CALLBACK_API_C(TQ3Status,
                       TQ3XRendererUpdateStyleMethod)(TQ3ViewObject view,
                                                      void *rendererPrivate,
                                                      const void *publicData);
/**
 *  Attributes
...
typedef CALLBACK_API_C(TQ3Status, TQ3XRendererUpdateAttributeMethod)(
    TQ3ViewObject view, void *rendererPrivate, const void *publicData);
/**
 *  Shaders
 */
enum { kQ3XMethodTypeRendererUpdateShaderMetaHandler = FOUR_CHAR_CODE('rdsu') };
 ...
 */
typedef CALLBACK_API_C(TQ3Status,
                       TQ3XRendererUpdateShaderMethod)(TQ3ViewObject view,
                                                       void *rendererPrivate,
                                                       TQ3Object *shaderObject);
/**
 *  Matrices
 */
enum { kQ3XMethodTypeRendererUpdateMatrixMetaHandler = FOUR_CHAR_CODE('rdxu') };
...
typedef CALLBACK_API_C(TQ3Status, TQ3XRendererUpdateMatrixMethod)(
    TQ3ViewObject view, void *rendererPrivate, const TQ3Matrix4x4 *matrix);
