...
#define CallQTVRBackBufferImagingProc(userRoutine, qtvr, drawRect, areaIndex,  \
  ...
  /** \name  QTVR Intercept Struct, Callback, Routine Descriptors */
...
#define CallQTVRInterceptProc(userRoutine, qtvr, qtvrMsg, refCon, cancel) \
  ...
  /** \name  Viewing Angles and Zooming */
  ...
  /** \name  Scene and Node Location Information */
  ...
  /** \name  Event & Cursor Handling Calls */
  ...
  /** \name Object Movie Specific Calls
    --
  ...
  /** \name View State Calls - QTVR Object Only */
  ...
  /** \name  Basic Conversion and Math Routines */
  ...
  /** \name  Viewing Limits and Constraints */
  ...
  /** \name  Back Buffer Memory Management */
