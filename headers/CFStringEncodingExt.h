/**
    ...
    \brief   CoreFoundation string encodings
...
#define __CFSTRINGENCODINGEXT__RESTORE_TWOBYTEINTS
...
#define __CFSTRINGENCODINGEXT__RESTORE_PACKED_ENUMS
...
enum CFStringEncodings {
  ...
  kCFStringEncodingMacGaelic =
      40, /* The following use script code 4, smArabic */
  ...
  kCFStringEncodingMacVT100 = 0xFC, /* VT100/102 font from Comm Toolbox: Latin-1
                                       repertoire + box drawing etc */
                                    /* Special Mac OS encodings*/
  kCFStringEncodingMacHFS =
      0xFF, /* Meta-value, should never appear in a table */
            /* Unicode & ISO UCS encodings begin at 0x100 */
  /* We don't use Unicode variations defined in TextEncoding; use the ones in
     CFString.h, instead. */
  ...
  kCFStringEncodingDOSChineseTrad =
      0x0423, /* code page 950, also for Windows */
              /*  kCFStringEncodingWindowsLatin1 = 0x0500, defined in
  ...
  kCFStringEncodingHZ_GB_2312 =
      0x0A05, /* HZ (RFC 1842, for Chinese mail & news) */
              ...
              /*  kCFStringEncodingNextStepLatin = 0x0B01, defined in
                 CoreFoundation/CFString.h */
...
typedef enum CFStringEncodings CFStringEncodings;

#if PRAGMA_ENUM_ALWAYSINT
#pragma enumsalwaysint reset
#ifdef __CFSTRINGENCODINGEXT__RESTORE_TWOBYTEINTS
#pragma fourbyteints off
#endif
#elif PRAGMA_ENUM_OPTIONS
#pragma option enum =reset
#elif defined(__CFSTRINGENCODINGEXT__RESTORE_PACKED_ENUMS)
#pragma options(pack_enums)
#endif
