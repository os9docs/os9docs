...
/**
   ...
   Use kO_ASYNC, kO_NDELAY and kO_NONBLOCK in the unlikely event you need the OT
   value in Carbon
*/
...
/**
   ...
   Only data netbufs may use this - no netbufs for addresses or options, or the
   like. Any OTBuffer returned to you by OT is read only! The astute will notice
   that this has a high correlation with the STREAMS msgb data type.  The fields
   are commented with their corresponding msgb field name.
*/
...
*/
/**
   TRequest is passed to OTSndRequest and OTRcvRequest that contains the
...
/**
   Under Carbon, the OpenMapper routines take a client context pointer.
   Applications may pass NULL after calling
   InitOpenTransport(kInitOTForApplicationMask, ...).  Non-applications must
   always pass a valid client context.
*/
