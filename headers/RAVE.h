...
typedef enum TQAMethodSelector TQAMethodSelector;
   ...
   *priority(this actually does nothing since the
   *bits are still 0000) QATextureNew(myEngine, flags, pixelType, image,
   *&raveTexture);
   ***To do a texture with a middle priority of 8, do the following : **unsigned long flags = kQATexture_HighCompression; // Initialize
   *flags
   *
