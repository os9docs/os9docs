...
#if TARGET_CPU_PPC
enum { kCompiledCFragArch = kPowerPCCFragArch };

#endif /* TARGET_CPU_PPC */

#if TARGET_CPU_68K
enum { kCompiledCFragArch = kMotorola68KCFragArch };
...
/**
   ...
   "CFM"-style routines whether or not they have the "pascal" keyword is
   irrelevant.
*/
...
/**
   ...
   introducing the phrase "CFrag" into constant and type names.  The old names
...
enum { kPowerPC = kPowerPCCFragArch, kMotorola68K = kMotorola68KCFragArch };
