/**
    ...
    \brief   Open Scripting Architecture Client Interfaces.

    \introduced_in  AppleScript 1.4
...
#pragma pack(2)
    ...
    **************************************************************************/
    ...
    /**
        ...
        */
    typedef CALLBACK_API(OSErr, OSACreateAppleEventProcPtr)(
    ...
    typedef CALLBACK_API(OSErr,
                         OSASendProcPtr)(const AppleEvent *theAppleEvent,
                                         AppleEvent *reply, AESendMode sendMode,
                                         AESendPriority sendPriority,
                                         long timeOutInTicks, AEIdleUPP idleProc,
                                         AEFilterUPP filterProc, long refCon);
    ...
    enum
    {
        uppOSACreateAppleEventProcInfo = 0x000FEFE0
    }; /** pascal 2_bytes Func(4_bytes, 4_bytes, 4_bytes, 2_bytes, 4_bytes, 4_bytes,
          4_bytes) */
#ifdef __cplusplus
    inline OSACreateAppleEventUPP
    NewOSACreateAppleEventUPP(OSACreateAppleEventProcPtr userRoutine)
    {
        return (OSACreateAppleEventUPP)NewRoutineDescriptor(
...
#define NewOSACreateAppleEventUPP(userRoutine)                  \
    ...
    enum
    {
        uppOSASendProcInfo = 0x003FEFE0
    }; /** pascal 2_bytes Func(4_bytes, 4_bytes, 4_bytes, 2_bytes, 4_bytes, 4_bytes,
          4_bytes, 4_bytes) */
#ifdef __cplusplus
    inline OSASendUPP NewOSASendUPP(OSASendProcPtr userRoutine)
    {
        return (OSASendUPP)NewRoutineDescriptor(
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
    inline void DisposeOSACreateAppleEventUPP(OSACreateAppleEventUPP userUPP)
    {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
    inline void DisposeOSASendUPP(OSASendUPP userUPP)
    {
        DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
    }
#else
#define DisposeOSASendUPP(userUPP) DisposeRoutineDescriptor(userUPP)
    ...
    InvokeOSACreateAppleEventUPP(AEEventClass theAEEventClass,
                                 ...
                                 long refCon, OSACreateAppleEventUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
    inline OSErr InvokeOSACreateAppleEventUPP(AEEventClass theAEEventClass,
                                              AEEventID theAEEventID,
                                              ...
                                              OSACreateAppleEventUPP userUPP)
    {
        return (OSErr)CALL_SEVEN_PARAMETER_UPP(
            userUPP, uppOSACreateAppleEventProcInfo, theAEEventClass, theAEEventID,
            target, returnID, transactionID, result, refCon);
    }
#else
#define InvokeOSACreateAppleEventUPP(theAEEventClass, theAEEventID, target,     \
    ...
    InvokeOSASendUPP(const AppleEvent *theAppleEvent, AppleEvent *reply,
                     ...
                     long timeOutInTicks, AEIdleUPP idleProc,
                     AEFilterUPP filterProc, long refCon, OSASendUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
    inline OSErr InvokeOSASendUPP(const AppleEvent *theAppleEvent,
                                  AppleEvent *reply, AESendMode sendMode,
                                  ...
                                  long refCon, OSASendUPP userUPP)
    {
        return (OSErr)CALL_EIGHT_PARAMETER_UPP(
            userUPP, uppOSASendProcInfo, theAppleEvent, reply, sendMode, sendPriority,
            timeOutInTicks, idleProc, filterProc, refCon);
    }
#else
#define InvokeOSASendUPP(theAppleEvent, reply, sendMode, sendPriority,       \
                         timeOutInTicks, idleProc, filterProc, refCon,       \
                         userUPP)                                            \
...
#define CallOSACreateAppleEventProc(userRoutine, theAEEventClass,         \
                                    theAEEventID, target, returnID,       \
                                    transactionID, result, refCon)        \
    InvokeOSACreateAppleEventUPP(theAEEventClass, theAEEventID, target,   \
                                 returnID, transactionID, result, refCon, \
                                 userRoutine)
#define CallOSASendProc(userRoutine, theAppleEvent, reply, sendMode,        \
    ...
    */
    ...
    /**
            ...
            OSACompileExecute, OSADoScript, OSAExecuteEvent, or OSADoEvent to
            indicate whether or not AppleEvents should be sent with the
       kAEDontRecord mode flag sent or not. NOTE: This flag is exactly the opposite
       sense of the AppleEvent flag kAEDontRecord.  This is to provide a more
       convenient default, i.e. not supplying any mode (kOSAModeNull) means to send
       events with kAEDontRecord.  Supplying the kOSAModeDoRecord mode flag will
    ...
    /**
       ...
       OSACompile. If used, output may be arbitrarily "beautified", e.g. quotes may
       be left off of string values, long lists may have elipses, etc.
        */
    enum
    {
    ...
    /**
       ...
       context's parent context.  When the stored context is loaded back in, the
       parent will be kOSANullScript.
        */
    enum
    {
    ...
    */
    ...
    /**
       ...
       component errOSACorruptData:          data seems to be corrupt
                errOSADataFormatObsolete    script data format is no longer
       supported errOSADataFormatTooNew      script data format is from a newer
       version
    ...
    /**
       ...
       component errAECoercionFail:      desiredType not supported by scripting
       component
        */
    ...
    /**
            ...
            Errors:
                ...
                errOSAInvalidID
                errOSABadSelector:      selector not supported by scripting
       component or selector not for this scriptID
        */
    /**
     *  OSAGetScriptInfo()
     *
    ...
    */
    ...
    enum
    {
        uppOSAActiveProcInfo = 0x000000E0
    }; /** pascal 2_bytes Func(4_bytes) */
#ifdef __cplusplus
    inline OSAActiveUPP NewOSAActiveUPP(OSAActiveProcPtr userRoutine)
    {
        return (OSAActiveUPP)NewRoutineDescriptor(
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
    inline void DisposeOSAActiveUPP(OSAActiveUPP userUPP)
    {
        DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
    }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
    inline OSErr InvokeOSAActiveUPP(long refCon, OSAActiveUPP userUPP)
    {
        return (OSErr)CALL_ONE_PARAMETER_UPP(userUPP, uppOSAActiveProcInfo, refCon);
    }
#else
#define InvokeOSAActiveUPP(refCon, userUPP) \
    (OSErr) CALL_ONE_PARAMETER_UPP((userUPP), uppOSAActiveProcInfo, (refCon))
#endif
#endif
...
#define CallOSAActiveProc(userRoutine, refCon) \
    InvokeOSAActiveUPP(refCon, userRoutine)
#endif /** CALL_NOT_IN_CARBON */
...
/**
    ...
    */
     ...
     *    \non_carbon_cfm   in AppleScriptLib 1.5 and later
...
/**
    ...
    **************************************************************************/
    ...
    /**
       ...
       component errOSACorruptData:          data seems to be corrupt
                errOSADataFormatObsolete    script data format is no longer
       supported errOSADataFormatTooNew      script data format is from a newer
       version errOSAInvalidID errOSAScriptError:          the executing script got
       an error
    ...
    /**
       ...
       component errOSAScriptError:      sourceData was a bad script (syntax error)
                errOSAInvalidID:        previousAndResultingCompiledScriptID was not
                                        valid on input
                errOSAScriptError:      the executing script got an error
    ...
    **************************************************************************/
    ...
    /**
       ...
       registered in the application with AEInstallEventHandler should be used, or
       no dispatch should occur, respectively.
    ...
    enum
    {
        keyProcedureName = FOUR_CHAR_CODE('dfnm'),  /** typeChar */
        keyStatementRange = FOUR_CHAR_CODE('dfsr'), /** typeStatementRange */
        keyLocalsNames = FOUR_CHAR_CODE('dfln'),    /** typeAEList of typeChar */
        keyGlobalsNames = FOUR_CHAR_CODE('dfgn'),   /** typeAEList of typeChar */
        keyParamsNames = FOUR_CHAR_CODE('dfpn')     /** typeAEList of typeChar */
    };
