...
EqualString ( strA,strB, TRUE,TRUE); /* Returns FALSE */
    ...
    If caseSens = FALSE, then both strings are treated as if they had been
                             ...
                             or lower in the collating sequence.The IUEqualString and IUCompString functions take into consideration special spelling conventions used in foreign languages.</ pre> * \copyright THINK Reference © 1991 - 1992 Symantec Corporation
