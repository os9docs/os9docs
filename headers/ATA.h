/**
    ...
    \brief   ATA (PC/AT Attachment) Interfaces
...
#pragma pack(2)
  ...
  {
    kATATrap =
        0xAAF1,                /** Manager trap number <This should be defined in Traps.h>*/
  ...
  enum
  {
    ...
    mATAMediaChanged =
        1 << bATAMediaChanged,            /** Media Changed Indicator (for removable)*/
    mATAIDNotFound = 1 << bATAIDNotFound, /** ID Not Found*/
    mATAMediaChangeReq =
        1 << bATAMediaChangeReq,                   /** Media Change Requested (NOT IMPLEMENTED)*/
  ...
  enum
  {
    ...
    mATADCRnIntEnable =
        1 << bATADCRnIntEnable /** Interrupt Disable(0 = enabled)*/
  };
  ...
  */
  ...
  enum
  {
    ...
    kATAMgrFindSpecialDriverRefnum =
        0x98, /** lookup a driver refnum; driverloader,notify-all or ROM driver.*/
    kATAMgrNextAvailable = 0x99
  };

  /** used in the ataDrvrFlags field for
   * kATAMgrDriveRegister,kATAMgrRemoveDriverRefnum &
   * kATAMgrFindSpecialDriverRefnum*/
  enum
  {
  ...
  enum
  {
    ...
    mATAFlagByteSwap =
        1
        << bATAFlagByteSwap,                /** Swap data bytes (read - after; write - before)*/
    mATAFlagIORead = 1 << bATAFlagIORead,   /** Read (in) operation*/
    mATAFlagIOWrite = 1 << bATAFlagIOWrite, /** Write (out) operation*/
    mATAFlagImmediate =
        1 << bATAFlagImmediate, /** Head of Que; Immediate operation*/
    mATAFlagQLock =
        1 << bATAFlagQLock, /** Manager queue lock on error (freeze the queue)*/
    mATAFlagUseScatterGather =
        1 << bATAFlagUseScatterGather, /** Scatter gather enable*/
    mATAFlagUseDMA = 1 << bATAFlagUseDMA,
    mATAFlagProtocolATAPI =
        1 << bATAFlagProtocolATAPI,            /** ATAPI protocol indicator*/
    mATAFlagTFRead = 1 << bATAFlagTFRead,      /** update reg block request upon
  ...
  enum
  {
    uppATACallbackProcInfo = 0x000000C0
  }; /** pascal no_return_value Func(4_bytes) */
#ifdef __cplusplus
  inline ATACallbackUPP NewATACallbackUPP(ATACallbackProcPtr userRoutine)
  {
    return (ATACallbackUPP)NewRoutineDescriptor(
        (ProcPtr)(userRoutine), uppATACallbackProcInfo, GetCurrentArchitecture());
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeATACallbackUPP(ATACallbackUPP userUPP)
  {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void InvokeATACallbackUPP(void *ataPB, ATACallbackUPP userUPP)
  {
    CALL_ONE_PARAMETER_UPP(userUPP, uppATACallbackProcInfo, ataPB);
  }
#else
#define InvokeATACallbackUPP(ataPB, userUPP) \
  CALL_ONE_PARAMETER_UPP((userUPP), uppATACallbackProcInfo, (ataPB))
#endif
#endif
...
#define CallATACallbackProc(userRoutine, ataPB) \
  InvokeATACallbackUPP(ataPB, userRoutine)
#endif /** CALL_NOT_IN_CARBON */

  /**

     structure which defines the ATA bus/device ID, part of the Device 0/1
     Software Guide see
     <http://developer.apple.com/techpubs/hardware/Developer_Notes/System_Software/ATA_Device_Zero_One.pdf>
     p 19 :   Although ataPBDeviceID remains defined as a 32-bit number, drivers
     and applications can typecast it to the ataDeviceID structure to determine
     the bus number and device number for a specific ATA or ATAPI device
  */
  struct ataDeviceID
  {
...
/**
   The kATADevIDProperty property will be inserted by the AIM when creating name
   registry entries for each drive found on the bus. The 4-byte data shall be
   the ataDeviceID structure used by ATA Manager. <3/14/2000>
*/
#define kATADevIDProperty "device_id"
  enum
  {
    kATADevIDPropertyNameLength =
        10,                   /** Number of characters in kATADevIDProperty including the
                                 terminating null.*/
  ...
  {
    UInt8 *ioBuf; /** if SG flag enabled then this points to the head of the list
                     else it is the buffer */
  ...
  */
  ...
  enum
  {
    ...
    kATADevice0DeviceID =
        0,                  /** aka, Master. Device 0 is the correct terminology */
  ...
  struct ATAInitInfo
  {
    ...
    UInt32 refCon;             /** <-- refCon to be associated with this instantiation of the
                                  AIM */
  };
  ...
  struct ataIOPB
  {
    ...
    SInt8 ataPBErrorRegister;        /** <--: Last ATA error image-valid if lsb of Status
                                        set*/
    SInt16 ataPBReserved5;           /** Reserved*/
    UInt32 ataPBLogicalBlockSize;    /** -->: Blind transfer size per interrupt
                                        (Logical block size)*/
    UInt8 *ataPBBuffer;              /** -->: Data buffer pointer*/
    UInt32 ataPBByteCount;           /** -->: Data transfer length in bytes*/
    ...
    ATAPICmdPacket *ataPBPacketPtr;  /** -->: ATAPI packet command block pointer
                                        (valid with ATAPI bit set)*/
  ...
  struct ataMgrInquiry
  {
    ...
    UInt8 Reserved2;                 /** Reserved*/
    UInt16
        ataIOClkResolution;  /** <--: IO Clock resolution in nsec (Not supported)*/
  ...
  enum
  {
    uppATAClientProcInfo = 0x000000E0
  }; /** pascal 2_bytes Func(4_bytes) */
#ifdef __cplusplus
  inline ATAClientUPP NewATAClientUPP(ATAClientProcPtr userRoutine)
  {
    return (ATAClientUPP)NewRoutineDescriptor(
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeATAClientUPP(ATAClientUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline SInt16 InvokeATAClientUPP(ATAEventRecPtr ataERPtr,
                                   ATAClientUPP userUPP)
  {
    return (SInt16)CALL_ONE_PARAMETER_UPP(userUPP, uppATAClientProcInfo,
                                          ataERPtr);
  }
#else
#define InvokeATAClientUPP(ataERPtr, userUPP) \
  (SInt16) CALL_ONE_PARAMETER_UPP((userUPP), uppATAClientProcInfo, (ataERPtr))
#endif
#endif
...
#define CallATAClientProc(userRoutine, ataERPtr) \
  InvokeATAClientUPP(ataERPtr, userRoutine)
#endif /** CALL_NOT_IN_CARBON */
  ...
  struct ataDrvrRegister
  {
    ...
    ATAClientUPP
        ataEventHandler;   /** <->: Pointer to ATA event callback routine {PB2}*/
  ...
  {
    bATAAltSDevCValid =
        14,                   /** bit number of alternate status/device cntrl valid bit*/
    ...
    mATAAltSDevCValid =
        1 << bATAAltSDevCValid,                       /** alternate status/device control valid*/
  ...
  struct ataRegAccess
  {
    ...
    UInt8 ataAltSDevCReg;         /** <->: Alternate status(R) or Device Control(W)
                                     register image*/
  ...
  /** 'ataConfigSetting' field of the Get/Set Device Configuration definition
   * <8/6/94>*/
  enum
  {
  ...
  */
  struct ataDevConfiguration
  {
    ...
    UInt16 atapcValid;     /** <->: Set when pcXXX fields are valid (atapcAccessMode -
                              atapcConfigIndex)*/
  ...
  struct ataAddATABus
  {
    ...
    SInt32 ataPBReserved4;         /** Reserved                         */
                                   /** End of cloned common header ataPBHdr*/
    RegEntryIDPtr ataNameRegEntry; /** -->: Pointer to name registry data*/
    CFragConnectionID connID;      /** -->: Reserved. Must be set to zero.*/
    UInt32 busID;                  /** <--: bus ID*/
    UInt8 flags;                   /** -->: add bus flags*/
    UInt8 socketType;              /** -->:   Socket type as defined in the enum*/
    Ptr iconData;                  /** -->: Ptr to 256 bytes of icon data (nil is OK)*/
    Ptr stringData;                /** -->: C String defining location of device. (nil is OK)*/
  };
  ...
  struct ataRemoveATABus
  {
    ...
    SInt32 ataPBReserved4;         /** Reserved                         */
                                   /** End of cloned common header ataPBHdr*/
    UInt32 busID;                  /** -->: Reserved. Must set to 0.             */
    RegEntryIDPtr ataNameRegEntry; /** -->: Pointer to name registry data */
  };
  ...
  union ataPB
  {
    ...
    ataModifyEventMask
        ataMEParamBlock;          /** parameter block for event mask modify*/
    ...
    ataDevConfiguration
        ataDCParamBlock;             /** parameter block for device configuration*/
    ataLocationData ataLDParamBlock; /** parameter block for location icon data*/
    /**ataManagerInit  ataInitParamBlock;     // parameter block for Manager
     * initialization*/
    /**ataManagerShutDn    ataSDParamBlock;     // parameter block for Manager
     * shutdown*/
    /**ataDrvrLoad     ataDLParamBlock;     // parameter block for Driver
     * loading*/
  ...
  enum
  {
    ...
    kATAUpdateEvent =
        0x07, /** Potential configuration change reported by CardServices <SM4>*/
    kATATaskTimeRequest =
        0x08,                 /** The manager is requesting to be called at Task Time*/
    ...
    /** The following describes bit definitions in the eventMask field of
       ataDrvrRegister*/
  ...
  {
    kATAEventMarker =
        FOUR_CHAR_CODE('LOAD'),    /** Marker for the event data structure*/
  ...
  enum
  {
    uppATADispatchProcInfo = 0x000000E0
  }; /** pascal 2_bytes Func(4_bytes) */
#ifdef __cplusplus
  inline ATADispatchUPP NewATADispatchUPP(ATADispatchProcPtr userRoutine)
  {
    return (ATADispatchUPP)NewRoutineDescriptor(
        (ProcPtr)(userRoutine), uppATADispatchProcInfo, GetCurrentArchitecture());
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeATADispatchUPP(ATADispatchUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline OSErr InvokeATADispatchUPP(ataPB *pb, ATADispatchUPP userUPP)
  {
    return (OSErr)CALL_ONE_PARAMETER_UPP(userUPP, uppATADispatchProcInfo, pb);
  }
#else
#define InvokeATADispatchUPP(pb, userUPP) \
  (OSErr) CALL_ONE_PARAMETER_UPP((userUPP), uppATADispatchProcInfo, (pb))
#endif
#endif
...
#define CallATADispatchProc(userRoutine, pb) \
  InvokeATADispatchUPP(pb, userRoutine)
#endif /** CALL_NOT_IN_CARBON */
...
/** Typedefs for the AIM entry point pointers*/
  ...
  typedef CALLBACK_API_C(void, ATAPluginAction)(UInt32 refCon, ATAReqBlock *pb);
...
/** Callbacks into the System 7 ATA Manager*/
   ...
   *    \non_carbon_cfm   in ATAManager 4 and later
   *    \carbon_lib        not available
   *    \mac_os_x         not available
   */
  void
  ...
  enum
  {
    ...
    ATAPICheckErr =
        ATABaseErrCode + 0x0D, /** 0xDB4F: ATAPI Check condition <06/15/94>*/
    AT_UltraDMAiCRCErr =
        ATABaseErrCode + 0x0E, /** 0xDB50: CRC error during Ultra DMA xfer */
    /** System error codes...Custom Driver Error Codes 0xDB60 - 0xDB6F*/
    DRVRCantAllocate = ATABaseErrCode +
                       0x1E, /** 0xDB60: Allocation error during initialization*/
    NoATAMgr =
        ATABaseErrCode + 0x1F,           /** 0xDB61: MgrInquiry failed => No ATA Manager*/
    ...
    ATADevUnsupported =
        ATABaseErrCode + 0x22, /** 0xDB64: Device type not supported*/
    ATAEjectDrvErr =
        ATABaseErrCode + 0x23, /** 0xDB65: Could not eject the drive*/
                               /** Manager Error Codes 0xDB70 - 0xDB8F*/
    ATAMgrNotInitialized =
        ATABaseErrCode + 0x2E, /** 0xDB70: Mgr has not been initialized*/
    ATAPBInvalid = ATABaseErrCode +
                   0x2F, /** 0xDB71: The bus base address couldn't be found*/
    ATAFuncNotSupported =
        ATABaseErrCode + 0x30,       /** 0xDB72: An unknown function code specified*/
    ATABusy = ATABaseErrCode + 0x31, /** 0xDB73: Selected device is busy*/
    ATATransTimeOut =
        ATABaseErrCode + 0x32, /** 0xDB74: Transaction timeout detected*/
    ATAReqInProg =
        ATABaseErrCode +
        0x33, /** 0xDB75: Channel busy; channel is processing another cmd*/
    ATAUnknownState =
        ATABaseErrCode +
        0x34, /** 0xDB76: Device status register reflects an unknown state*/
    ATAQLocked =
        ATABaseErrCode +
        0x35, /** 0xDB77: I/O Queue is locked due to previous I/O error.*/
    ATAReqAborted =
        ATABaseErrCode +
        0x36, /** 0xDB78: The I/O queue entry was aborted due to an abort req.*/
              /**         or due to Manager shutdown.*/
    ATAUnableToAbort =
        ATABaseErrCode +
        0x37, /** 0xDB79: The I/O queue entry could not be aborted.*/
    ATAAbortedDueToRst =
        ATABaseErrCode +
    ...
    ATANoClientErr =
        ATABaseErrCode + 0x3B, /** 0xDB7D: No client present to handle the event*/
    ATAInternalErr =
        ATABaseErrCode + 0x3C,            /** 0xDB7E: MagnumOpus returned an error*/
    ...
    DriverLocked =
        ATABaseErrCode +
        0x3F, /** 0xDB81: Current driver must be removed before adding another*/
    CantHandleEvent =
        ATABaseErrCode +
        0x40, /** 0xDB82: Particular event couldn't be handled (call others)*/
    ATAMgrMemoryErr =
        ATABaseErrCode + 0x41,            /** 0xDB83: Manager memory allocation error    */
    ATASDFailErr = ATABaseErrCode + 0x42, /** 0xDB84: Shutdown failure          */
    ATAXferParamErr =
        ATABaseErrCode + 0x43, /** 0xDB85: I/O xfer parameters inconsistent */
    ATAXferModeErr =
        ATABaseErrCode + 0x44, /** 0xDB86: I/O xfer mode not supported */
    ATAMgrConsistencyErr =
        ATABaseErrCode +
        0x45, /** 0XDB87: Manager detected internal inconsistency. */
    ATADmaXferErr =
        ATABaseErrCode + 0x46, /** 0XDB88: fatal error in DMA side of transfer */
                               /** Driver loader error Codes 0xDB90 - 0xDBA5*/
    ATAInvalidDrvNum =
        ATABaseErrCode + 0x4E,            /** 0xDB90: Invalid drive number from event*/
    ...
    ATANoDriverErr =
        ATABaseErrCode + 0x51 /** 0xDB93: No driver found on the media   */
  };
