/**
    ...
    \brief   CoreFoundation character sets
 ...
 */
EXTERN_API_C(CFMutableCharacterSetRef)
CFCharacterSetCreateMutableCopy(CFAllocatorRef alloc, CFCharacterSetRef theSet);
...
CFCharacterSetIsCharacterMember(CFCharacterSetRef theSet, UniChar theChar);
