/**
    ...
    \brief   Nib support for Carbon

    \introduced_in  CarbonLib 1.1/Mac OS X
 ...
 */
EXTERN_API_C(OSStatus)
CreateNibReferenceWithCFBundle(CFBundleRef inBundle, CFStringRef inNibName,
                               IBNibRef *outNibRef);
 ...
 */
EXTERN_API_C(OSStatus)
CreateWindowFromNib(IBNibRef inNibRef, CFStringRef inName,
                    WindowRef *outWindow);
