/**
    ...
    \brief   SoundSprocket interfaces
...
enum { kSSpMedium_Air = 0, kSSpMedium_Water = 1 };
 ...
 *    \non_carbon_cfm   in SoundSprocketLib 1.0 and later
 *    \carbon_lib        not in Carbon, but SoundSprocketLib is compatible with
 Carbon
 ...
 *    \non_carbon_cfm   in SoundSprocketLib 1.7 and later
 *    \carbon_lib        not in Carbon, but SoundSprocketLib is compatible with
 Carbon
 *    \mac_os_x         not available
 */
