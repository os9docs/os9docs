...
#pragma pack(2)
  ...
  {
    /** Scripting */
    AppleEvent Errors cmspInvalidImageFile = -4220                          // Plugin cannot handle this image file type   cmspInvalidImageSpace =
                                             - 4221,                        /** cannot */
    create an image file of this colorspace cmspInvalidProfileEmbed = -4222 /** invalid */
                                                                      profile errors cmspInvalidProfileSource = -4223 cmspInvalidProfileDest = -4224,
  ...
  enum
  {
    cmspFavorEmbeddedMask =
        // reserved for future use: currently 0 profile embedded in image if present
  };
