/**
    ...
    \brief   Interfaces to Find by Content Plugins that scan files

    \introduced_in  Mac OS 8.6
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeIAAllocUPP(IAAllocUPP userUPP)
  {
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeIAFreeUPP(IAFreeUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeIAIdleUPP(IAIdleUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void *InvokeIAAllocUPP(UInt32 inSize, IAAllocUPP userUPP)
  {
    return (void *)CALL_ONE_PARAMETER_UPP(userUPP, uppIAAllocProcInfo, inSize);
  }
#else
#define InvokeIAAllocUPP(inSize, userUPP) \
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void InvokeIAFreeUPP(void *inObject, IAFreeUPP userUPP)
  {
    CALL_ONE_PARAMETER_UPP(userUPP, uppIAFreeProcInfo, inObject);
  }
#else
#define InvokeIAFreeUPP(inObject, userUPP) \
  CALL_ONE_PARAMETER_UPP((userUPP), uppIAFreeProcInfo, (inObject))
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline UInt8 InvokeIAIdleUPP(IAIdleUPP userUPP)
  {
    return (UInt8)CALL_ZERO_PARAMETER_UPP(userUPP, uppIAIdleProcInfo);
  }
#else
#define InvokeIAIdleUPP(userUPP) \
  (UInt8) CALL_ZERO_PARAMETER_UPP((userUPP), uppIAIdleProcInfo)
#endif
#endif
...
#define CallIAIdleProc(userRoutine) InvokeIAIdleUPP(userRoutine)
  ...
  typedef CALLBACK_API_C(OSStatus,
                         IADocAccessorReadProcPtr)(IADocAccessorRef inAccessor,
  ...
  typedef STACK_UPP_TYPE(IASetDocAccessorReadPositionProcPtr)
      IASetDocAccessorReadPositionUPP;
  typedef STACK_UPP_TYPE(IAGetDocAccessorReadPositionProcPtr)
  ...
  enum
  {
    uppIADocAccessorOpenProcInfo = 0x000000F1
  }; /* 4_bytes Func(4_bytes) */
#ifdef __cplusplus
  ...
  NewIADocAccessorOpenUPP(IADocAccessorOpenProcPtr userRoutine)
  {
    return (IADocAccessorOpenUPP)NewRoutineDescriptor(
        (ProcPtr)(userRoutine), uppIADocAccessorOpenProcInfo,
        GetCurrentArchitecture());
  }
#else
#define NewIADocAccessorOpenUPP(userRoutine)                                \
  ...
  enum
  {
    uppIADocAccessorCloseProcInfo = 0x000000F1
  }; /* 4_bytes Func(4_bytes) */
#ifdef __cplusplus
  ...
  NewIADocAccessorCloseUPP(IADocAccessorCloseProcPtr userRoutine)
  {
    return (IADocAccessorCloseUPP)NewRoutineDescriptor(
        (ProcPtr)(userRoutine), uppIADocAccessorCloseProcInfo,
        GetCurrentArchitecture());
  }
#else
#define NewIADocAccessorCloseUPP(userRoutine)                                 \
  ...
  NewIADocAccessorReadUPP(IADocAccessorReadProcPtr userRoutine)
  {
    return (IADocAccessorReadUPP)NewRoutineDescriptor(
        (ProcPtr)(userRoutine), uppIADocAccessorReadProcInfo,
        GetCurrentArchitecture());
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeIADocAccessorOpenUPP(IADocAccessorOpenUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeIADocAccessorCloseUPP(IADocAccessorCloseUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeIADocAccessorReadUPP(IADocAccessorReadUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeIASetDocAccessorReadPositionUPP(
      IASetDocAccessorReadPositionUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
#define DisposeIASetDocAccessorReadPositionUPP(userUPP) \
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeIAGetDocAccessorReadPositionUPP(
      IAGetDocAccessorReadPositionUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
#define DisposeIAGetDocAccessorReadPositionUPP(userUPP) \
  DisposeRoutineDescriptor(userUPP)
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline void DisposeIAGetDocAccessorEOFUPP(IAGetDocAccessorEOFUPP userUPP)
  {
    DisposeRoutineDescriptor((UniversalProcPtr)userUPP);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline OSStatus InvokeIADocAccessorOpenUPP(IADocAccessorRef inAccessor,
                                             IADocAccessorOpenUPP userUPP)
  {
    return (OSStatus)CALL_ONE_PARAMETER_UPP(userUPP, uppIADocAccessorOpenProcInfo,
                                            inAccessor);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline OSStatus InvokeIADocAccessorCloseUPP(IADocAccessorRef inAccessor,
                                              IADocAccessorCloseUPP userUPP)
  {
    return (OSStatus)CALL_ONE_PARAMETER_UPP(
        userUPP, uppIADocAccessorCloseProcInfo, inAccessor);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline OSStatus InvokeIADocAccessorReadUPP(IADocAccessorRef inAccessor,
                                             void *buffer, UInt32 *ioSize,
                                             IADocAccessorReadUPP userUPP)
  {
    return (OSStatus)CALL_THREE_PARAMETER_UPP(
        userUPP, uppIADocAccessorReadProcInfo, inAccessor, buffer, ioSize);
  }
#else
#define InvokeIADocAccessorReadUPP(inAccessor, buffer, ioSize, userUPP)        \
  ...
  {
    return (OSStatus)CALL_THREE_PARAMETER_UPP(
        userUPP, uppIASetDocAccessorReadPositionProcInfo, inAccessor, inMode,
        inOffset);
  }
#else
#define InvokeIASetDocAccessorReadPositionUPP(inAccessor, inMode, inOffset,    \
                                              userUPP)                         \
                                        ...
                                        IAGetDocAccessorReadPositionUPP userUPP)
  {
    return (OSStatus)CALL_TWO_PARAMETER_UPP(
        userUPP, uppIAGetDocAccessorReadPositionProcInfo, inAccessor, outPostion);
  }
#else
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
  inline OSStatus InvokeIAGetDocAccessorEOFUPP(IADocAccessorRef inAccessor,
                                               SInt32 *outEOF,
                                               IAGetDocAccessorEOFUPP userUPP)
  {
    return (OSStatus)CALL_TWO_PARAMETER_UPP(
        userUPP, uppIAGetDocAccessorEOFProcInfo, inAccessor, outEOF);
  }
#else
...
#define NewIADocAccessorReadProc(userRoutine) \
  NewIADocAccessorReadUPP(userRoutine)
#define NewIASetDocAccessorReadPositionProc(userRoutine) \
  NewIASetDocAccessorReadPositionUPP(userRoutine)
#define NewIAGetDocAccessorReadPositionProc(userRoutine) \
  NewIAGetDocAccessorReadPositionUPP(userRoutine)
#define NewIAGetDocAccessorEOFProc(userRoutine) \
  NewIAGetDocAccessorEOFUPP(userRoutine)
...
#define CallIASetDocAccessorReadPositionProc(userRoutine, inAccessor, inMode, \
  ...
  InvokeIASetDocAccessorReadPositionUPP(inAccessor, inMode, inOffset,         \
                                        userRoutine)
#define CallIAGetDocAccessorReadPositionProc(userRoutine, inAccessor, \
                                             outPostion)              \
...
#endif
/**
    A Sherlock Plugin is a CFM shared library that implements the following
   functions:
*/
...
*/
  ...
  */
  ...
  /**
     IAGetExtractorVersion - returns the version of the Text Extractor interface
     that the plug-in was built with.
  */
  /**
  ...
  /**
     IACountSupportedDocTypes - returns number of document types the plug-in
     supports
  */
  /**
  ...
  /**
     IAGetIndSupportedDocType - returns the nth document type the plug-in
     supports. First item is one not zero.  Returns the MIME type of supported
     document
  */
  /**
  ...
  /**
     IAOpenDocument - returns a reference to the text of a document.  Client
     passes in an IADocAccessorRecord* that the plug-in can use to to access a
     document.  Plug-in returns IADocRef which an opaque type defined by plug-in
     to reference the text of a document.
  */
  /**
   *  IAOpenDocument()
   *
  ...
  /**
     IACloseDocument - perform any cleanup for IADocRef that was returned from
     IAOpenDocument.
  */
  /**
   *  IACloseDocument()
  ...
  /**
     IAGetNextTextRun - get next run of text.  On input, ioSize is the length of
     buffer argument. On output, ioSize contains the number of bytes written to
     buffer argument
  */
  /**
   *  IAGetNextTextRun()
  ...
  /**
     IAGetTextRunInfo - get information about the text returned from the last call
     to IAGetNextTextRun. Arguments outEncoding ane outLanguage are options an
     NULL can be passed in.  If arguments are non-null, plug-in will return
     pointer to internet encoding and language of last run of text. If encoding or
     language are unknown, plug-in will set *outEncoding and/or *outLanguage to
     NULL.
  */
  /**
   *  IAGetTextRunInfo()
